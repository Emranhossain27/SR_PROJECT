...
/* specialFilter(std::vector<int, std::allocator<int> >) */

int specialFilter(vector<int,std::allocator<int>> *param_1)

{
  ...
  while( true ) {
    ...
    uVar2 = std::vector<int,std::allocator<int>>::size(param_1);
    if (uVar2 <= uVar1) break;
    piVar3 = (int *)std::vector<int,std::allocator<int>>::operator[](param_1,(long)local_18);
    if (10 < *piVar3) {
      piVar3 = (int *)std::vector<int,std::allocator<int>>::operator[](param_1,(long)local_18);
      std::__cxx11::to_string(local_38,*piVar3);
                    /* try { // try from 00102245 to 00102283 has its CatchHandler @ 001022a9 */
      pcVar4 = (char *)std::__cxx11::string::operator[]((string *)local_38,0);
      if ((int)*pcVar4 % 2 == 1) {
        lVar5 = std::__cxx11::string::length((string *)local_38);
        pcVar4 = (char *)std::__cxx11::string::operator[]((string *)local_38,lVar5 - 1);
        if ((int)*pcVar4 % 2 == 1) {
          local_14 = local_14 + 1;
        }
      }
...
/* WARNING: Removing unreachable block (ram,0x0010245e) */
...

{
  ...
  local_30 = CONCAT31(local_30._1_3_,bVar2);
                    /* try { // try from 0010244d to 00102451 has its CatchHandler @ 00102471 */
...
{
                    /* try { // try from 00102987 to 0010298b has its CatchHandler @ 00102994 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 001029b4 to 001029b8 has its CatchHandler @ 00102a14 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 00102c2e to 00102c6b has its CatchHandler @ 00102c83 */
...
/* WARNING: Removing unreachable block (ram,0x00102d96) */
