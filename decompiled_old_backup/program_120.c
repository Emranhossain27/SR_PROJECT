...

{
  ...
  pvVar1 = (void *)(*(code *)PTR_memcpy_00106028)();
  return pvVar1;
}
...

{
  ...
  pvVar1 = (void *)(*(code *)PTR_operator_new_00106030)();
  return pvVar1;
}
...
{
  (*(code *)PTR_operator_delete_00106038)();
  return;
}
...

{
  ...
  pvVar1 = (void *)(*(code *)PTR_memmove_00106040)();
  return pvVar1;
}
...
/* maximum(std::vector<int, std::allocator<int> >, int) */

vector<int,std::allocator<int>> *
maximum(vector<int,std::allocator<int>> *param_1,vector<int,std::allocator<int>> *param_2,
       int param_3)

{
  __new_allocator<int> local_a1;
  undefined8 local_a0;
  long local_98;
  long local_90;
  undefined1 local_81;
  ...
  local_68 = param_2;
  local_60 = param_1;
  local_78 = std::vector<int,std::allocator<int>>::begin(param_2);
  local_80 = std::vector<int,std::allocator<int>>::end(param_2);
  std::sort<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>>
            (local_78,local_80);
  local_81 = 0;
  local_98 = std::vector<int,std::allocator<int>>::end(param_2);
  local_50 = (long)local_6c;
  local_48 = &local_98;
  local_90 = local_98 + local_50 * -4;
  local_18 = local_40;
  local_20 = &local_58;
  local_58 = local_90;
  local_a0 = std::vector<int,std::allocator<int>>::end(param_2);
  local_38 = &local_a1;
  local_10 = local_38;
                    /* try { // try from 001012d2 to 001012d6 has its CatchHandler @ 001012f9 */
  std::vector<int,std::allocator<int>>::
  vector<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>,void>
            (param_1,local_90,local_a0);
  local_30 = &local_a1;
  std::__new_allocator<int>::~__new_allocator(local_30);
  return param_1;
}
...
/* std::vector<int, std::allocator<int> >::vector<__gnu_cxx::__normal_iterator<int*,
   std::vector<int, std::allocator<int> > >, void>(__gnu_cxx::__normal_iterator<int*,
   std::vector<int, std::allocator<int> > >, __gnu_cxx::__normal_iterator<int*, std::vector<int,
   std::allocator<int> > >, std::allocator<int> const&) */
...

{
  ...
  _Vector_base<int,std::allocator<int>>::_Vector_base
            ((_Vector_base<int,std::allocator<int>> *)this,param_4);
  local_10 = &local_18;
                    /* try { // try from 0010144d to 00101451 has its CatchHandler @ 0010145a */
  _M_range_initialize<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>>
            (this,local_18,param_3);
  return;
}
...

{
  ...
  local_30 = SUB168(auVar1 / SEXT816(2),0);
  local_28 = local_f8;
  local_38 = param_1 + local_30 * 4;
  local_10 = local_20;
  local_18 = &local_38;
  local_58 = local_f8;
  local_68[1] = 1;
  local_68[0] = param_1 + 4;
  local_40 = local_50;
  local_48 = local_68;
  local_d8 = &local_100;
  local_e8[1] = 1;
  local_e8[0] = param_2 + -4;
  local_c0 = local_d0;
  local_c8 = local_e8;
  local_100 = param_2;
  local_f8[0] = param_1;
  ...
  __move_median_to_first<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>,__gnu_cxx::__ops::_Iter_less_iter>
            (param_1,local_68[0],local_38,local_e8[0]);
  local_88 = local_f8;
  local_98[1] = 1;
  local_98[0] = local_f8[0] + 4;
  local_70 = local_80;
  local_78 = local_98;
  uVar2 = __unguarded_partition<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>,__gnu_cxx::__ops::_Iter_less_iter>
                    (local_98[0],local_100,local_f8[0]);
  return uVar2;
}
...
void std::vector<int,std::allocator<int>>::
     _M_range_initialize<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>>
               (vector<int,std::allocator<int>> *param_1,long param_2,long param_3)

{
  ...
  local_18 = local_28;
  local_10 = local_20;
  _M_range_initialize_n<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>,__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>>
            (param_1,param_2,param_3,param_3 - param_2 >> 2);
  return;
}
...
{
                    /* try { // try from 00103312 to 00103316 has its CatchHandler @ 00103328 */
...
/* void std::vector<int, std::allocator<int>
   >::_M_range_initialize_n<__gnu_cxx::__normal_iterator<int*, std::vector<int, std::allocator<int>
   > >, __gnu_cxx::__normal_iterator<int*, std::vector<int, std::allocator<int> > >
   >(__gnu_cxx::__normal_iterator<int*, std::vector<int, std::allocator<int> > >,
   __gnu_cxx::__normal_iterator<int*, std::vector<int, std::allocator<int> > >, unsigned long) */

void __thiscall
std::vector<int,std::allocator<int>>::
_M_range_initialize_n<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>,__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>>
          (vector<int,std::allocator<int>> *this,undefined8 param_2,undefined8 param_3,ulong param_4
          )

{
  ...
  paVar1 = (allocator *)
           _Vector_base<int,std::allocator<int>>::_M_get_Tp_allocator
                     ((_Vector_base<int,std::allocator<int>> *)this);
  uVar2 = _S_check_init_len(param_4,paVar1);
  lVar3 = _Vector_base<int,std::allocator<int>>::_M_allocate
                    ((_Vector_base<int,std::allocator<int>> *)this,uVar2);
  *(long *)(this + 8) = lVar3;
  *(long *)this = lVar3;
  *(ulong *)(this + 0x10) = lVar3 + param_4 * 4;
  uVar4 = _Vector_base<int,std::allocator<int>>::_M_get_Tp_allocator
                    ((_Vector_base<int,std::allocator<int>> *)this);
  piVar5 = __uninitialized_copy_a<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>,__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>,int*,int>
                     (param_2,param_3,lVar3,uVar4);
  *(int **)(this + 8) = piVar5;
  return;
}
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* int* std::__uninitialized_copy_a<__gnu_cxx::__normal_iterator<int*, std::vector<int,
   std::allocator<int> > >, __gnu_cxx::__normal_iterator<int*, std::vector<int, std::allocator<int>
...
int * std::
      __uninitialized_copy_a<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>,__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>,int*,int>
                (undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  int *piVar1;
  
  piVar1 = uninitialized_copy<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>,int*>
                     (param_1,param_2,param_3);
  return piVar1;
}
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 00103616 to 00103622 has its CatchHandler @ 00103636 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
...
/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* int* std::uninitialized_copy<__gnu_cxx::__normal_iterator<int*, std::vector<int,
   std::allocator<int> > >, int*>(__gnu_cxx::__normal_iterator<int*, std::vector<int,
   std::allocator<int> > >, __gnu_cxx::__normal_iterator<int*, std::vector<int, std::allocator<int>
   > >, int*) */

int * std::
      uninitialized_copy<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>,int*>
