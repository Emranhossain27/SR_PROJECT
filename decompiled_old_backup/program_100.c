...
/* WARNING: Removing unreachable block (ram,0x001012bf) */
/* make_a_pile(int) */

vector<int,std::allocator<int>> * make_a_pile(int param_1)

{
  ...
  local_30 = this;
  local_10 = local_28;
                    /* try { // try from 0010121c to 00101220 has its CatchHandler @ 0010127f */
  std::vector<int,std::allocator<int>>::vector(this,local_48,1);
  local_20 = &local_4d;
  std::__new_allocator<int>::~__new_allocator(local_20);
  for (local_60 = 1; local_60 < local_34; local_60 = local_60 + 1) {
    lVar1 = std::vector<int,std::allocator<int>>::size(this);
    piVar2 = (int *)std::vector<int,std::allocator<int>>::operator[](this,lVar1 - 1);
    local_64 = *piVar2 + 2;
                    /* try { // try from 00101267 to 0010126f has its CatchHandler @ 0010129e */
    std::vector<int,std::allocator<int>>::push_back(this,&local_64);
  }
  return this;
}
...

{
  ...
  uVar3 = initializer_list<int>::size((initializer_list<int> *)&local_18);
                    /* try { // try from 0010134f to 00101353 has its CatchHandler @ 0010135c */
...
{
                    /* try { // try from 00101652 to 00101656 has its CatchHandler @ 00101668 */
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 00101896 to 001018a2 has its CatchHandler @ 001018b6 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00101fa9 to 00101fad has its CatchHandler @ 00101fb8 */
