...
/* simplify(std::__cxx11::string, std::__cxx11::string) */

ulong simplify(string *param_1,string *param_2)

{
  ...
  local_20 = param_2;
  local_18 = param_1;
  for (local_34 = 0; uVar1 = (ulong)local_34, uVar2 = std::__cxx11::string::size(param_1),
      uVar1 < uVar2; local_34 = local_34 + 1) {
    pcVar3 = (char *)std::__cxx11::string::operator[](param_1,(long)local_34);
    if (*pcVar3 == '/') {
      std::__cxx11::string::substr((ulong)local_58,(ulong)param_1);
      pcVar3 = (char *)std::__cxx11::string::c_str(local_58);
      local_24 = atoi(pcVar3);
      std::__cxx11::string::~string(local_58);
      std::__cxx11::string::substr((ulong)local_78,(ulong)param_1);
      pcVar3 = (char *)std::__cxx11::string::c_str(local_78);
      local_28 = atoi(pcVar3);
      std::__cxx11::string::~string(local_78);
    }
  }
  for (local_34 = 0; uVar1 = (ulong)local_34, uVar2 = std::__cxx11::string::size(param_2),
      uVar1 < uVar2; local_34 = local_34 + 1) {
    pcVar3 = (char *)std::__cxx11::string::operator[](param_2,(long)local_34);
    if (*pcVar3 == '/') {
      std::__cxx11::string::substr((ulong)local_98,(ulong)param_2);
      pcVar3 = (char *)std::__cxx11::string::c_str(local_98);
      local_2c = atoi(pcVar3);
      std::__cxx11::string::~string(local_98);
      std::__cxx11::string::substr((ulong)local_b8,(ulong)param_2);
      pcVar3 = (char *)std::__cxx11::string::c_str(local_b8);
      local_30 = atoi(pcVar3);
      std::__cxx11::string::~string(local_b8);
    }
  }
  return CONCAT71((int7)((ulong)((long)(local_24 * local_2c) / (long)(local_28 * local_30)) >> 8),
                  (local_24 * local_2c) % (local_28 * local_30) == 0) & 0xffffff01;
}
...

{
  undefined8 uVar1;
                    ...
                    /* try { // try from 00102530 to 00102534 has its CatchHandler @ 00102545 */
  uVar1 = _M_data(this);
  return uVar1;
}
...
{
                    /* try { // try from 00102564 to 00102568 has its CatchHandler @ 0010257a */
  _M_dispose(this);
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 00102698 to 0010269c has its CatchHandler @ 001026de */
...

{
  ...
  local_28 = this;
                    /* try { // try from 0010278e to 001027cb has its CatchHandler @ 001027e3 */
...

{
  ...
  local_28 = &local_49;
  local_10 = local_28;
                    /* try { // try from 00102906 to 0010290a has its CatchHandler @ 00102997 */
  ...
  lVar2 = _M_data(local_38);
                    /* try { // try from 00102936 to 0010298b has its CatchHandler @ 001029b6 */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00102af2 to 00102b0d has its CatchHandler @ 00102b22 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00102da1 to 00102da5 has its CatchHandler @ 00102db0 */
