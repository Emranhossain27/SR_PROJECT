...
/* largest_smallest_integers(std::vector<int, std::allocator<int> >) */

undefined8 largest_smallest_integers(undefined8 param_1,vector<int,std::allocator<int>> *param_2)

{
  ulong uVar1;
  ulong uVar2;
  int *piVar3;
  __new_allocator<int> local_61;
  int local_60;
  int local_5c;
  int *local_58;
  undefined8 local_50;
  ...
  do {
    ...
    if (uVar2 <= uVar1) {
      ...
      local_28 = &local_61;
      local_10 = local_28;
                    /* try { // try from 0010130a to 0010130e has its CatchHandler @ 0010132f */
      std::vector<int,std::allocator<int>>::vector(param_1,local_58,2);
      local_20 = &local_61;
      std::__new_allocator<int>::~__new_allocator(local_20);
      return param_1;
    }
    piVar3 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_44);
    if (*piVar3 < 0) {
      if (local_3c != 0) {
        piVar3 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_44);
        if (*piVar3 <= local_3c) goto LAB_0010127b;
      }
      piVar3 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_44);
      local_3c = *piVar3;
    }
LAB_0010127b:
    ...
    if (0 < *piVar3) {
      if (local_40 != 0) {
        piVar3 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_44);
        if (local_40 <= *piVar3) goto LAB_001012c2;
      }
      piVar3 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_44);
      local_40 = *piVar3;
    }
...

{
  ...
  uVar3 = initializer_list<int>::size((initializer_list<int> *)&local_18);
                    /* try { // try from 0010147f to 00101483 has its CatchHandler @ 0010148c */
...
{
                    /* try { // try from 00101642 to 00101646 has its CatchHandler @ 00101658 */
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 00101886 to 00101892 has its CatchHandler @ 001018a6 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
