...
/* intersperse(std::vector<int, std::allocator<int> >, int) */

vector<int,std::allocator<int>> *
intersperse(vector<int,std::allocator<int>> *param_1,vector<int,std::allocator<int>> *param_2,
           int param_3)

{
  ...
  lVar1 = std::vector<int,std::allocator<int>>::size(param_2);
  if (lVar1 != 0) {
    piVar2 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,0);
                    /* try { // try from 0010123e to 001012a9 has its CatchHandler @ 00101247 */
    std::vector<int,std::allocator<int>>::push_back(param_1,piVar2);
  }
  for (local_30 = 1; uVar3 = std::vector<int,std::allocator<int>>::size(param_2),
      (ulong)(long)local_30 < uVar3; local_30 = local_30 + 1) {
    std::vector<int,std::allocator<int>>::push_back(param_1,&local_1c);
    piVar2 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_30);
    std::vector<int,std::allocator<int>>::push_back(param_1,piVar2);
  }
  return param_1;
}
...
{
                    /* try { // try from 00101562 to 00101566 has its CatchHandler @ 00101578 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00101ac9 to 00101acd has its CatchHandler @ 00101ad8 */
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 00101b86 to 00101b92 has its CatchHandler @ 00101ba6 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
