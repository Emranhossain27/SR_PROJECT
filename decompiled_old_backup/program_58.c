...
/* common(std::vector<int, std::allocator<int> >, std::vector<int, std::allocator<int> >) */

vector<int,std::allocator<int>> *
common(vector<int,std::allocator<int>> *param_1,vector<int,std::allocator<int>> *param_2,
...

{
  ...
  for (local_68 = 0; uVar1 = (ulong)local_68,
      uVar2 = std::vector<int,std::allocator<int>>::size(param_2), uVar1 < uVar2;
      local_68 = local_68 + 1) {
    local_78 = std::vector<int,std::allocator<int>>::begin(param_1);
    local_80 = std::vector<int,std::allocator<int>>::end(param_1);
    uVar3 = std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_68);
                    /* try { // try from 001012ae to 00101447 has its CatchHandler @ 001013e0 */
    local_70 = std::
               find<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>,int>
                         (local_78,local_80,uVar3);
    local_98[0] = std::vector<int,std::allocator<int>>::end(param_1);
    local_40 = &local_70;
    local_48 = local_98;
    local_18 = local_48;
    local_10 = local_40;
    if (local_70 == local_98[0]) {
      local_a8 = std::vector<int,std::allocator<int>>::begin(param_3);
      local_b0 = std::vector<int,std::allocator<int>>::end(param_3);
      uVar3 = std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_68);
      local_a0 = std::
                 find<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>,int>
                           (local_a8,local_b0,uVar3);
      local_b8 = std::vector<int,std::allocator<int>>::end(param_3);
      local_30 = &local_a0;
      local_38 = &local_b8;
      local_28 = local_38;
      local_20 = local_30;
      if (local_a0 != local_b8) {
        piVar4 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_68);
        std::vector<int,std::allocator<int>>::push_back(param_1,piVar4);
      }
    }
  }
  uVar3 = std::vector<int,std::allocator<int>>::begin(param_1);
  uVar5 = std::vector<int,std::allocator<int>>::end(param_1);
  std::sort<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>>(uVar3,uVar5);
  return param_1;
}
...
{
                    /* try { // try from 001017f2 to 001017f6 has its CatchHandler @ 00101808 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00101e19 to 00101e1d has its CatchHandler @ 00101e28 */
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 00101ed6 to 00101ee2 has its CatchHandler @ 00101ef6 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
...

{
  ...
  while (local_160 < (long)(local_168 - 1) / 2) {
    ...
    local_10 = local_20;
    local_18 = &local_38;
    local_60 = local_180 + -1;
    local_58 = &local_150;
    local_190 = local_150 + local_60 * 4;
    local_40 = local_50;
    local_48 = &local_68;
    local_68 = local_190;
    local_38 = local_188;
    ...
    local_b8 = &local_150;
    local_c0 = local_160;
    local_c8 = (undefined4 *)(local_150 + local_160 * 4);
    local_a0 = local_b0;
    local_a8 = &local_c8;
    local_138 = local_1a0;
    *local_c8 = *local_198;
  ...
  if (((local_168 & 1) == 0) && (local_160 == (long)(local_168 - 2) / 2)) {
    ...
    local_e8 = &local_150;
    local_1a8 = (undefined4 *)(local_150 + local_f0 * 4);
    local_d0 = local_e0;
    local_d8 = &local_f8;
    local_140 = &local_1a8;
    local_118 = &local_150;
...

{
  ...
  while( true ) {
    ...
    local_88 = local_e8;
    local_90 = local_f0;
    local_98 = (undefined4 *)(local_e8[0] + local_f0 * 4);
    local_70 = local_80;
    local_78 = &local_98;
    local_d8 = local_128;
    *local_98 = *local_120;
