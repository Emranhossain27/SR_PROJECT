...
vector<int,std::allocator<int>> * f(int param_1)

{
  ...
  for (local_24 = 1; local_24 <= local_14; local_24 = local_24 + 1) {
    ...
    if (local_24 % 2 == 0) {
                    /* try { // try from 00101243 to 00101277 has its CatchHandler @ 00101254 */
      std::vector<int,std::allocator<int>>::push_back(this,&local_1c);
    }
    else {
      std::vector<int,std::allocator<int>>::push_back(this,&local_18);
    }
  }
  return this;
}
