...
/* is_nested(std::__cxx11::string) */

undefined8 is_nested(string *param_1)
...
LAB_00101220:
    ...
    pcVar3 = (char *)std::__cxx11::string::operator[](param_1,(long)local_24);
    if (*pcVar3 == '[') {
      local_1c = local_1c + 1;
    }
    pcVar3 = (char *)std::__cxx11::string::operator[](param_1,(long)local_24);
    ...
    if ((int)local_1c <= (int)(local_20 - 2)) {
      local_9 = 1;
      goto LAB_00101220;
    }
    local_24 = local_24 + 1;
...

{
  ...
  local_28 = this;
                    /* try { // try from 0010133e to 0010137b has its CatchHandler @ 00101393 */
