...
/* sum_squares(std::vector<float, std::allocator<float> >) */

int sum_squares(vector<float,std::allocator<float>> *param_1)

{
  ...
  while( true ) {
    ...
    fVar3 = (float)std::ceil(*pfVar2);
    pfVar2 = (float *)std::vector<float,std::allocator<float>>::operator[](param_1,(long)local_18);
    fVar4 = (float)std::ceil(*pfVar2);
    local_14 = (int)(fVar3 * fVar4 + (float)local_14);
    local_18 = local_18 + 1;
  }
  return local_14;
}
