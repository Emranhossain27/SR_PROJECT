...
undefined8 eat(int param_1,int param_2,int param_3)

{
  int in_ECX;
  undefined4 in_register_0000003c;
  undefined8 uVar1;
  __new_allocator<int> local_a9;
  int local_a8;
  int local_a4;
  int *local_a0;
  undefined8 local_98;
  ...
  local_50 = uVar1;
  if (in_ECX < param_3) {
    local_78[0] = param_2 + in_ECX;
    local_78[1] = 0;
    local_70 = local_78;
    local_68 = 2;
    local_48 = &local_79;
    local_10 = local_48;
                    /* try { // try from 00101236 to 0010123a has its CatchHandler @ 00101253 */
    std::vector<int,std::allocator<int>>::vector(uVar1,local_70,2);
    local_38 = &local_79;
    std::__new_allocator<int>::~__new_allocator(local_38);
  }
  else {
    local_a8 = param_2 + param_3;
    local_a4 = in_ECX - param_3;
    local_a0 = &local_a8;
    local_98 = 2;
    local_40 = &local_a9;
    local_18 = local_40;
                    /* try { // try from 001012d5 to 001012d9 has its CatchHandler @ 001012f2 */
    std::vector<int,std::allocator<int>>::vector(uVar1,local_a0,2);
    local_28 = &local_a9;
...

{
  ...
  uVar3 = initializer_list<int>::size((initializer_list<int> *)&local_18);
                    /* try { // try from 0010139f to 001013a3 has its CatchHandler @ 001013ac */
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 001017a6 to 001017b2 has its CatchHandler @ 001017c6 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
