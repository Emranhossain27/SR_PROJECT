...
/* move_one_ball(std::vector<int, std::allocator<int> >) */

undefined8 move_one_ball(vector<int,std::allocator<int>> *param_1)

{
  ...
  local_1c = 0;
  lVar3 = std::vector<int,std::allocator<int>>::size(param_1);
  if (lVar3 == 0) {
    local_9 = 1;
    uVar4 = 0;
  }
    ...
    while( true ) {
      ...
      piVar5 = (int *)std::vector<int,std::allocator<int>>::operator[](param_1,(long)local_20);
      iVar1 = *piVar5;
    ...
    lVar3 = std::vector<int,std::allocator<int>>::size(param_1);
    puVar6 = (uint *)std::vector<int,std::allocator<int>>::operator[](param_1,lVar3 - 1);
    uVar2 = *puVar6;
    piVar5 = (int *)std::vector<int,std::allocator<int>>::operator[](param_1,0);
    if (*piVar5 < (int)uVar2) {
      uVar2 = local_1c + 1;
      local_1c = uVar2;
    }
