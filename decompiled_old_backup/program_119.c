...
/* match_parens(std::vector<std::__cxx11::string, std::allocator<std::__cxx11::string > >) */

string * match_parens(string *param_1,
...

{
  ...
  psVar1 = (string *)
           std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[]
                     (param_2,0);
  std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[](param_2,1);
  std::operator+(local_b8,psVar1);
  local_c0 = 0;
  local_c1 = 1;
  local_bc = 0;
  while( true ) {
    uVar2 = (ulong)local_bc;
    uVar3 = std::__cxx11::string::length(local_b8);
    if (uVar3 <= uVar2) break;
                    /* try { // try from 001022b1 to 0010230f has its CatchHandler @ 001022e6 */
    pcVar4 = (char *)std::__cxx11::string::operator[](local_b8,(long)local_bc);
    if (*pcVar4 == '(') {
      local_c0 = local_c0 + 1;
    }
    pcVar4 = (char *)std::__cxx11::string::operator[](local_b8,(long)local_bc);
  ...
  if (local_c0 == 0) {
    if ((local_c1 & 1) == 1) {
      local_80 = &local_dd;
      local_18 = local_80;
                    /* try { // try from 00102406 to 00102411 has its CatchHandler @ 00102437 */
      std::__cxx11::string::string<std::allocator<char>>(param_1,"Yes",local_80);
      local_58 = (__new_allocator<char> *)&local_dd;
      ...
      psVar1 = (string *)
               std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[]
                         (param_2,1);
      std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[](param_2,0);
                    /* try { // try from 00102494 to 0010254b has its CatchHandler @ 001022e6 */
      std::operator+(local_100,psVar1);
      ...
      if ((local_c1 & 1) == 1) {
        local_78 = &local_101;
        local_20 = local_78;
                    /* try { // try from 001025c3 to 001025ce has its CatchHandler @ 001025f4 */
        std::__cxx11::string::string<std::allocator<char>>(param_1,"Yes",local_78);
        local_48 = (__new_allocator<char> *)&local_101;
        std::__new_allocator<char>::~__new_allocator(local_48);
      }
      else {
        local_70 = &local_102;
        local_28 = local_70;
                    /* try { // try from 00102639 to 00102644 has its CatchHandler @ 00102667 */
        std::__cxx11::string::string<std::allocator<char>>(param_1,"No",local_70);
        local_38 = (__new_allocator<char> *)&local_102;
    ...
    local_88 = local_d5;
    local_10 = local_88;
                    /* try { // try from 00102380 to 0010238b has its CatchHandler @ 001023b1 */
    std::__cxx11::string::string<std::allocator<char>>(param_1,"No",local_88);
    local_68 = (__new_allocator<char> *)local_d5;
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 0010275f to 00102763 has its CatchHandler @ 00102784 */
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 00102908 to 0010295f has its CatchHandler @ 00102916 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 00102908 with catch @ 00102916 */
...
/* WARNING: Removing unreachable block (ram,0x001029b8) */
...

{
  ...
  char *local_40;
                    ...
                    /* try { // try from 0010299f to 00102aa4 has its CatchHandler @ 00102b6a */
  _M_is_local(this);
...
{
                    /* try { // try from 00102b94 to 00102b98 has its CatchHandler @ 00102baa */
  _M_dispose(this);
  _Alloc_hider::~_Alloc_hider((_Alloc_hider *)this);
  return;
}
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 00102cb8 to 00102cbc has its CatchHandler @ 00102cfe */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 00102e72 to 00102ea2 has its CatchHandler @ 00102eb1 */
...

{
  char *pcVar1;
                    ...
                    /* try { // try from 00102fcf to 00102ffd has its CatchHandler @ 00103006 */
  pcVar1 = (char *)_M_local_data(this);
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 00103214 to 00103218 has its CatchHandler @ 00103274 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 001038b2 to 001038cd has its CatchHandler @ 001038e2 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00103981 to 00103985 has its CatchHandler @ 00103990 */
...
{
                    /* try { // try from 001039b0 to 001039b8 has its CatchHandler @ 001039c1 */
  _M_set_length(this,0);
  return;
}
