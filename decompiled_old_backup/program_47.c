...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* median(std::vector<float, std::allocator<float> >) */

float median(vector<float,std::allocator<float>> *param_1)

{
  ...
  uVar2 = std::vector<float,std::allocator<float>>::begin(param_1);
  uVar3 = std::vector<float,std::allocator<float>>::end(param_1);
  std::sort<__gnu_cxx::__normal_iterator<float*,std::vector<float,std::allocator<float>>>>
            (uVar2,uVar3);
  uVar4 = std::vector<float,std::allocator<float>>::size(param_1);
  if ((uVar4 & 1) == 1) {
    uVar4 = std::vector<float,std::allocator<float>>::size(param_1);
    pfVar5 = (float *)std::vector<float,std::allocator<float>>::operator[](param_1,uVar4 >> 1);
    local_c = *pfVar5;
  }
  else {
    uVar4 = std::vector<float,std::allocator<float>>::size(param_1);
    ...
    fVar1 = *pfVar5;
    uVar4 = std::vector<float,std::allocator<float>>::size(param_1);
    pfVar5 = (float *)std::vector<float,std::allocator<float>>::operator[](param_1,(uVar4 >> 1) - 1)
    ;
    local_c = (float)(_DAT_00104008 * (double)(fVar1 + *pfVar5));
  }
  return local_c;
}
