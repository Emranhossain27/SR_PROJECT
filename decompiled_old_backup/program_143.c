...
/* words_in_sentence(std::__cxx11::string) */

string * words_in_sentence(string *param_1,string *param_2)

{
  ...
  local_50 = param_1;
  local_10 = local_48;
                    /* try { // try from 0010224f to 0010225a has its CatchHandler @ 001023a8 */
  ...
  local_40 = &local_91;
                    /* try { // try from 00102281 to 00102293 has its CatchHandler @ 001023ca */
  local_18 = local_40;
  ...
  std::__new_allocator<char>::~__new_allocator(local_28);
                    /* try { // try from 001022b1 to 00102496 has its CatchHandler @ 001023ef */
  ...
  while( true ) {
    ...
    if (*pcVar3 == ' ') {
      local_e1 = 1;
      local_e8 = std::__cxx11::string::length(local_90);
      if (local_e8 < 2) {
        local_e1 = 0;
      }
      for (local_ec = 2; local_ec * local_ec <= local_e8; local_ec = local_ec + 1) {
        if (local_e8 % local_ec == 0) {
          local_e1 = 0;
        }
      }
      if ((local_e1 & 1) != 0) {
        std::operator+(local_130,param_1);
                    /* try { // try from 00102499 to 001024b0 has its CatchHandler @ 001024e0 */
        std::operator+(local_110,(char)local_130);
        std::__cxx11::string::operator=(param_1,local_110);
        std::__cxx11::string::~string(local_110);
        std::__cxx11::string::~string(local_130);
      }
                    /* try { // try from 001024fa to 0010250c has its CatchHandler @ 001023ef */
      std::__cxx11::string::operator=(local_90,"");
    }
    else {
      std::__cxx11::string::operator[](param_2,(long)local_bc);
      std::operator+(local_e0,(char)local_90);
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 001025e8 to 0010263f has its CatchHandler @ 001025f6 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 001025e8 with catch @ 001025f6 */
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 001026bb to 001026c9 has its CatchHandler @ 001026e7 */
...

{
  ...
  char *local_40;
                    ...
                    /* try { // try from 0010272f to 00102834 has its CatchHandler @ 001028fa */
  _M_is_local(this);
...
{
                    /* try { // try from 00102924 to 00102928 has its CatchHandler @ 0010293a */
  _M_dispose(this);
  _Alloc_hider::~_Alloc_hider((_Alloc_hider *)this);
  return;
}
...

{
  ...
  lVar2 = size(this);
                    /* try { // try from 00102bdd to 00102be6 has its CatchHandler @ 00102bef */
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 00102cf8 to 00102cfc has its CatchHandler @ 00102d3e */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00102f12 to 00102f2d has its CatchHandler @ 00102f42 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00103151 to 00103155 has its CatchHandler @ 00103160 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 0010318e to 001031cb has its CatchHandler @ 001031e3 */
...
/* WARNING: Removing unreachable block (ram,0x0010349f) */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 00103462 to 00103492 has its CatchHandler @ 001034a1 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 00103588 to 0010359f has its CatchHandler @ 001035a8 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 001036b4 to 001036b8 has its CatchHandler @ 00103714 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...
{
                    /* try { // try from 00103970 to 00103978 has its CatchHandler @ 00103981 */
  _M_set_length(this,0);
  return;
}
...

{
  ...
  paVar3 = (allocator *)_M_get_allocator(param_1);
                    /* try { // try from 00103a15 to 00103ad6 has its CatchHandler @ 00103adf */
