...
/* correct_bracketing(std::__cxx11::string) */

undefined8 correct_bracketing(string *param_1)
...
LAB_00101200:
    ...
    pcVar4 = (char *)std::__cxx11::string::operator[](param_1,(long)local_20);
    if (*pcVar4 == '(') {
      local_1c = local_1c + 1;
    }
    pcVar4 = (char *)std::__cxx11::string::operator[](param_1,(long)local_20);
...

{
  ...
  local_28 = this;
                    /* try { // try from 0010131e to 0010135b has its CatchHandler @ 00101373 */
