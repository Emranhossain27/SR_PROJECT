...
/* solutions(std::vector<int, std::allocator<int> >) */

int solutions(vector<int,std::allocator<int>> *param_1)

{
  ...
  while( true ) {
    ...
    if (uVar1 <= (ulong)(long)(local_18 << 1)) break;
    piVar2 = (int *)std::vector<int,std::allocator<int>>::operator[](param_1,(long)(local_18 << 1));
    if (*piVar2 % 2 == 1) {
      piVar2 = (int *)std::vector<int,std::allocator<int>>::operator[]
                                (param_1,(long)(local_18 << 1));
