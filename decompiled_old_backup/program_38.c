...
/* WARNING: Removing unreachable block (ram,0x001023be) */
/* encode_cyclic(std::__cxx11::string) */

string * encode_cyclic(string *param_1,string *param_2)

{
  ...
  local_18 = param_2;
  local_10 = param_1;
  local_1c = std::__cxx11::string::length(param_2);
  local_20 = (local_1c + 2) / 3;
  std::__cxx11::string::string(local_40);
  local_41 = 0;
  std::__cxx11::string::string(param_1);
  for (local_48 = 0; local_48 * 3 < local_1c; local_48 = local_48 + 1) {
                    /* try { // try from 0010228d to 001022e1 has its CatchHandler @ 00102343 */
    std::__cxx11::string::substr((ulong)local_68,(ulong)param_2);
    std::__cxx11::string::operator=(local_40,local_68);
    std::__cxx11::string::~string(local_68);
    lVar1 = std::__cxx11::string::length(local_40);
    if (lVar1 == 3) {
      std::__cxx11::string::substr((ulong)local_b8,(ulong)local_40);
                    /* try { // try from 001022e4 to 00102316 has its CatchHandler @ 00102354 */
      ...
      std::__cxx11::string::~string(local_b8);
                    ...
                    /* try { // try from 0010236e to 00102384 has its CatchHandler @ 00102343 */
    std::operator+(local_d8,param_1);
    std::__cxx11::string::operator=(param_1,local_d8);
...
/* decode_cyclic(std::__cxx11::string) */

string * decode_cyclic(string *param_1,string *param_2)

{
  ...
  std::__cxx11::string::string(param_1);
  for (local_48 = 0; local_48 * 3 < local_1c; local_48 = local_48 + 1) {
                    /* try { // try from 0010249d to 00102514 has its CatchHandler @ 0010255f */
    std::__cxx11::string::substr((ulong)local_68,(ulong)param_2);
    std::__cxx11::string::operator=(local_40,local_68);
    std::__cxx11::string::~string(local_68);
    lVar2 = std::__cxx11::string::length(local_40);
    if (lVar2 == 3) {
      pcVar3 = (char *)std::__cxx11::string::operator[](local_40,2);
      cVar1 = *pcVar3;
      std::__cxx11::string::substr((ulong)local_b8,(ulong)local_40);
                    /* try { // try from 00102517 to 00102532 has its CatchHandler @ 00102570 */
      std::operator+((char)local_98,(string *)(ulong)(uint)(int)cVar1);
      std::__cxx11::string::operator=(local_40,local_98);
      std::__cxx11::string::~string(local_98);
      std::__cxx11::string::~string(local_b8);
    }
                    /* try { // try from 0010258a to 001025a0 has its CatchHandler @ 0010255f */
    std::operator+(local_d8,param_1);
    std::__cxx11::string::operator=(param_1,local_d8);
    std::__cxx11::string::~string(local_d8);
  }
...

{
  ...
  local_30 = this;
                    /* try { // try from 0010266b to 001026b6 has its CatchHandler @ 001026bf */
...
/* WARNING: Removing unreachable block (ram,0x00102768) */
...

{
  ...
  char *local_40;
                    ...
                    /* try { // try from 0010274f to 00102854 has its CatchHandler @ 0010291a */
  _M_is_local(this);
...
{
                    /* try { // try from 00102944 to 00102948 has its CatchHandler @ 0010295a */
  _M_dispose(this);
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 00102abf to 00102ac3 has its CatchHandler @ 00102ae4 */
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* std::__cxx11::string std::TEMPNAMEPLACEHOLDERVALUE(char, std::__cxx11::string&&) */
...

{
  ...
  psVar1 = (string *)__cxx11::string::insert(in_RDX,0,1,(char)param_2);
  __cxx11::string::string((string *)CONCAT71(in_register_00000039,param_1),psVar1);
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 00102d78 to 00102d7c has its CatchHandler @ 00102dbe */
...

{
  ...
  local_28 = this;
                    /* try { // try from 00102e9e to 00102edb has its CatchHandler @ 00102ef3 */
...

{
  ...
  local_28 = &local_49;
  local_10 = local_28;
                    /* try { // try from 00103016 to 0010301a has its CatchHandler @ 001030a7 */
  _Alloc_hider::_Alloc_hider((_Alloc_hider *)this,pcVar1,local_28);
  local_20 = (__new_allocator<char> *)&local_49;
  __new_allocator<char>::~__new_allocator(local_20);
  lVar2 = _M_data(local_38);
                    /* try { // try from 00103046 to 0010309b has its CatchHandler @ 001030c6 */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 001031a2 to 001031bd has its CatchHandler @ 001031d2 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 001033f1 to 001033f5 has its CatchHandler @ 00103400 */
...
{
                    /* try { // try from 00103560 to 00103568 has its CatchHandler @ 00103571 */
  _M_set_length(this,0);
  return;
}
...

{
  ...
  paVar3 = (allocator *)_M_get_allocator(param_1);
                    /* try { // try from 00103605 to 001036c6 has its CatchHandler @ 001036cf */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 00103874 to 00103878 has its CatchHandler @ 001038d4 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 00103be2 to 00103c12 has its CatchHandler @ 00103c21 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 00103d08 to 00103d1f has its CatchHandler @ 00103d28 */
...
/* std::__cxx11::string::insert(unsigned long, unsigned long, char) */

void __thiscall std::__cxx11::string::insert(string *this,ulong param_1,ulong param_2,char param_3)

{
  ulong uVar1;
  
  uVar1 = _M_check(this,param_1,"basic_string::insert");
  _M_replace_aux(this,uVar1,0,param_2,param_3);
  return;
}
