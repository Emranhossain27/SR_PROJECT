...
/* count_nums(std::vector<int, std::allocator<int> >) */

int count_nums(vector<int,std::allocator<int>> *param_1)

{
  ...
  local_14 = 0;
  for (local_18 = 0; uVar1 = std::vector<int,std::allocator<int>>::size(param_1),
      (ulong)(long)local_18 < uVar1; local_18 = local_18 + 1) {
    piVar2 = (int *)std::vector<int,std::allocator<int>>::operator[](param_1,(long)local_18);
    if (*piVar2 < 1) {
      local_1c = 0;
      piVar2 = (int *)std::vector<int,std::allocator<int>>::operator[](param_1,(long)local_18);
      local_20 = *piVar2;
      ...
      for (; 9 < local_20; local_20 = local_20 / 10) {
        local_1c = local_20 % 10 + local_1c;
      }
      if (0 < local_1c - local_20) {
        local_14 = local_14 + 1;
      }
    }
    else {
