...
/* WARNING: Removing unreachable block (ram,0x0010132d) */
/* unique_digits(std::vector<int, std::allocator<int> >) */

vector<int,std::allocator<int>> *
unique_digits(vector<int,std::allocator<int>> *param_1,vector<int,std::allocator<int>> *param_2)

{
  ...
  for (local_20 = 0; uVar2 = std::vector<int,std::allocator<int>>::size(param_2),
      (ulong)(long)local_20 < uVar2; local_20 = local_20 + 1) {
    piVar3 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_20);
    local_24 = *piVar3;
    bVar6 = local_24 != 0;
    while( true ) {
      bVar1 = false;
    ...
    if (bVar6) {
      piVar3 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_20);
                    /* try { // try from 001012ca to 00101320 has its CatchHandler @ 001012d3 */
      std::vector<int,std::allocator<int>>::push_back(param_1,piVar3);
    }
  }
  uVar4 = std::vector<int,std::allocator<int>>::begin(param_1);
...
{
                    /* try { // try from 00101672 to 00101676 has its CatchHandler @ 00101688 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00101b79 to 00101b7d has its CatchHandler @ 00101b88 */
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 00101c36 to 00101c42 has its CatchHandler @ 00101c56 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
