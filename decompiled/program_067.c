...
/* digitSum(std::__cxx11::string) */

int digitSum(string *param_1)

{
  ...
  while( true ) {
    ...
    pcVar2 = (char *)std::__cxx11::string::operator[](param_1,(long)local_18);
    if ('@' < *pcVar2) {
      pcVar2 = (char *)std::__cxx11::string::operator[](param_1,(long)local_18);
      if (*pcVar2 < '[') {
        pcVar2 = (char *)std::__cxx11::string::operator[](param_1,(long)local_18);
...

{
  ...
  local_28 = this;
                    /* try { // try from 0010130e to 0010134b has its CatchHandler @ 00101363 */
