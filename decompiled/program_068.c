...
/* fruit_distribution(std::__cxx11::string, int) */

int fruit_distribution(string *param_1,int param_2)

{
  ...
  local_48 = &local_79;
                    /* try { // try from 00102229 to 00102238 has its CatchHandler @ 0010238a */
  local_54 = param_2;
  local_50 = param_1;
  local_10 = local_48;
  ...
  local_40 = &local_b1;
                    /* try { // try from 0010225f to 00102271 has its CatchHandler @ 001023af */
  local_18 = local_40;
  std::__cxx11::string::string<std::allocator<char>>(local_b0,"",local_40);
  local_28 = (__new_allocator<char> *)&local_b1;
  std::__new_allocator<char>::~__new_allocator(local_28);
  local_b8 = 0;
  for (local_bc = 0; uVar4 = (ulong)local_bc, uVar5 = std::__cxx11::string::size(param_1),
      iVar1 = local_54, uVar4 < uVar5; local_bc = local_bc + 1) {
                    /* try { // try from 001022d7 to 00102438 has its CatchHandler @ 001023d7 */
    pcVar6 = (char *)std::__cxx11::string::operator[](param_1,(long)local_bc);
    if ((*pcVar6 < '0') ||
       (pcVar6 = (char *)std::__cxx11::string::operator[](param_1,(long)local_bc), '9' < *pcVar6)) {
      if ((local_b8 == 0) && (lVar7 = std::__cxx11::string::length(local_78), lVar7 != 0)) {
        local_b8 = 1;
      }
    }
    else {
      if (local_b8 == 0) {
        std::__cxx11::string::operator[](param_1,(long)local_bc);
        std::operator+(local_e0,(char)local_78);
        std::__cxx11::string::operator=(local_78,local_e0);
        std::__cxx11::string::~string(local_e0);
      }
      if (local_b8 == 1) {
        std::__cxx11::string::operator[](param_1,(long)local_bc);
        std::operator+(local_100,(char)local_b0);
        std::__cxx11::string::operator=(local_b0,local_100);
        std::__cxx11::string::~string(local_100);
      }
    }
  }
  pcVar6 = (char *)std::__cxx11::string::c_str(local_78);
  iVar2 = atoi(pcVar6);
  pcVar6 = (char *)std::__cxx11::string::c_str(local_b0);
  iVar3 = atoi(pcVar6);
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 00102568 to 001025bf has its CatchHandler @ 00102576 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 00102568 with catch @ 00102576 */
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 001026fb to 00102709 has its CatchHandler @ 00102727 */
...
/* WARNING: Removing unreachable block (ram,0x00102788) */
...

{
  ...
  char *local_40;
                    ...
                    /* try { // try from 0010276f to 00102874 has its CatchHandler @ 0010293a */
  _M_is_local(this);
...
{
                    /* try { // try from 00102964 to 00102968 has its CatchHandler @ 0010297a */
  _M_dispose(this);
  _Alloc_hider::~_Alloc_hider((_Alloc_hider *)this);
  return;
}
...

{
  undefined8 uVar1;
                    ...
                    /* try { // try from 001029c0 to 001029c4 has its CatchHandler @ 001029d5 */
  uVar1 = _M_data(this);
  return uVar1;
}
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 00102af8 to 00102afc has its CatchHandler @ 00102b3e */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00102cf2 to 00102d0d has its CatchHandler @ 00102d22 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00102f31 to 00102f35 has its CatchHandler @ 00102f40 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 00102f6e to 00102fab has its CatchHandler @ 00102fc3 */
...
/* WARNING: Removing unreachable block (ram,0x0010327f) */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 00103242 to 00103272 has its CatchHandler @ 00103281 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 00103348 to 0010335f has its CatchHandler @ 00103368 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 00103474 to 00103478 has its CatchHandler @ 001034d4 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...
{
                    /* try { // try from 00103730 to 00103738 has its CatchHandler @ 00103741 */
  _M_set_length(this,0);
  return;
}
