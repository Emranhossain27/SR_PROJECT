...
/* intersection[abi:cxx11](std::vector<int, std::allocator<int> >, std::vector<int,
   std::allocator<int> >) */

string * intersection_abi_cxx11_
                   (string *param_1,vector<int,std::allocator<int>> *param_2,
...

{
  ...
  local_78 = param_2;
  local_70 = param_1;
  piVar1 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,0);
  piVar2 = (int *)std::vector<int,std::allocator<int>>::operator[](param_3,0);
  piVar1 = std::max<int>(piVar1,piVar2);
  local_84 = *piVar1;
  piVar1 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,1);
  piVar2 = (int *)std::vector<int,std::allocator<int>>::operator[](param_3,1);
  piVar1 = std::min<int>(piVar1,piVar2);
  local_88 = *piVar1;
  local_8c = local_88 - local_84;
  if (local_8c < 2) {
    local_68 = &local_91;
    local_10 = local_68;
                    /* try { // try from 001022d0 to 001022db has its CatchHandler @ 001022f7 */
    std::__cxx11::string::string<std::allocator<char>>(param_1,"NO",local_68);
    local_50 = (__new_allocator<char> *)&local_91;
    std::__new_allocator<char>::~__new_allocator(local_50);
  }
  else {
    for (local_90 = 2; local_90 * local_90 <= local_8c; local_90 = local_90 + 1) {
      if (local_8c % local_90 == 0) {
        local_60 = local_a5;
        local_18 = local_60;
                    /* try { // try from 00102371 to 0010237c has its CatchHandler @ 00102398 */
        std::__cxx11::string::string<std::allocator<char>>(param_1,"NO",local_60);
        local_40 = (__new_allocator<char> *)local_a5;
    ...
    local_58 = &local_a6;
    local_20 = local_58;
                    /* try { // try from 001023f3 to 001023fe has its CatchHandler @ 00102417 */
    std::__cxx11::string::string<std::allocator<char>>(param_1,"YES",local_58);
    local_30 = (__new_allocator<char> *)&local_a6;
...
int * std::min<int>(int *param_1,int *param_2)
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 001025a8 to 001025ff has its CatchHandler @ 001025b6 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 001025a8 with catch @ 001025b6 */
...

{
  ...
  __cxx11::string__(&local_68,param_1);
                    /* try { // try from 00102782 to 001027b4 has its CatchHandler @ 001027c9 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00102a31 to 00102a35 has its CatchHandler @ 00102a40 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 00102a6e to 00102aab has its CatchHandler @ 00102ac3 */
