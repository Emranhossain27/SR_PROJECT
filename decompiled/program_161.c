...
/* solve(std::__cxx11::string) */

string * solve(string *param_1,string *param_2)

{
  ...
  long lVar4;
  long lVar5;
  __new_allocator<char> local_d9;
  undefined1 local_d8 [8];
  undefined1 local_d0 [15];
  undefined1 local_c1;
  string local_c0 [39];
  char local_99;
  int local_98;
  ...
  local_5c = 0;
  local_48 = &local_81;
                    /* try { // try from 00102232 to 00102241 has its CatchHandler @ 001022e1 */
  local_58 = param_2;
  local_50 = param_1;
  local_10 = local_48;
  std::__cxx11::string::string<std::allocator<char>>(local_80,"",local_48);
  local_38 = (__new_allocator<char> *)&local_81;
  std::__new_allocator<char>::~__new_allocator(local_38);
  for (local_98 = 0; uVar1 = (ulong)local_98, uVar2 = std::__cxx11::string::length(param_2),
      uVar1 < uVar2; local_98 = local_98 + 1) {
                    /* try { // try from 0010229a to 0010236b has its CatchHandler @ 00102309 */
    pcVar3 = (char *)std::__cxx11::string::operator[](param_2,(long)local_98);
    local_99 = *pcVar3;
    if ((local_99 < 'A') || ('Z' < local_99)) {
      if ((local_99 < 'a') || ('z' < local_99)) {
        local_5c = local_5c + 1;
      }
      else {
        local_99 = local_99 + -0x20;
      }
    }
    else {
      local_99 = local_99 + ' ';
    }
    std::operator+(local_c0,(char)local_80);
    std::__cxx11::string::operator=(local_80,local_c0);
    std::__cxx11::string::~string(local_c0);
  }
  lVar4 = (long)local_5c;
  lVar5 = std::__cxx11::string::length(param_2);
  if (lVar4 == lVar5) {
    local_c1 = 0;
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 00102528 to 0010257f has its CatchHandler @ 00102536 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 00102528 with catch @ 00102536 */
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 0010269b to 001026a9 has its CatchHandler @ 001026c7 */
...

{
  ...
  char *local_40;
                    ...
                    /* try { // try from 0010270f to 00102808 has its CatchHandler @ 001028ce */
  _M_is_local(this);
...
{
                    /* try { // try from 001028f4 to 001028f8 has its CatchHandler @ 0010290a */
  _M_dispose(this);
  _Alloc_hider::~_Alloc_hider((_Alloc_hider *)this);
  return;
}
...

{
  ...
  *(undefined8 *)(this + 8) = 0;
  ...
  reverse_iterator<__gnu_cxx::__normal_iterator<char*,std::__cxx11::string>>::reverse_iterator
            (local_40,param_3);
                    /* try { // try from 00102a0b to 00102a1b has its CatchHandler @ 00102a24 */
  local_10 = param_2;
...

{
  ...
  ulong uVar5;
                    ...
                    /* try { // try from 00102a6f to 00102b59 has its CatchHandler @ 00102b62 */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00102ff2 to 00102ff6 has its CatchHandler @ 00103020 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00103191 to 00103195 has its CatchHandler @ 001031a0 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 001031ce to 0010320b has its CatchHandler @ 00103223 */
...
/* WARNING: Removing unreachable block (ram,0x001032f6) */
...
/* WARNING: Removing unreachable block (ram,0x0010348f) */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 00103452 to 00103482 has its CatchHandler @ 00103491 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 00103578 to 0010357c has its CatchHandler @ 00103596 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 001036a4 to 001036a8 has its CatchHandler @ 00103704 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...

{
  ...
  reverse_iterator<__gnu_cxx::__normal_iterator<char*,std::__cxx11::string>>::reverse_iterator
            (local_98,param_3);
                    /* try { // try from 00103b8f to 00103b93 has its CatchHandler @ 00103bc0 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00103cc1 to 00103cc5 has its CatchHandler @ 00103cd0 */
    _M_dispose(*(string **)this);
  }
  return;
}
