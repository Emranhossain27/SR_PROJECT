...

{
  ...
  iVar1 = (*(code *)PTR_memcmp_00107020)();
  return iVar1;
}
...

{
  ...
  pvVar1 = (void *)(*(code *)PTR_memset_00107030)();
  return pvVar1;
}
...
{
  (*(code *)PTR___throw_out_of_range_fmt_00107058)();
  return;
}
...
/* WARNING: Removing unreachable block (ram,0x00102311) */
/* filter_by_prefix(std::vector<std::__cxx11::string, std::allocator<std::__cxx11::string > >,
   std::__cxx11::string) */

vector<std::__cxx11::string,std::allocator<std::__cxx11::string>> *
filter_by_prefix(vector<std::__cxx11::string,std::allocator<std::__cxx11::string>> *param_1,
...

{
  ...
  for (local_28 = 0; uVar2 = (ulong)local_28,
      ...
      uVar2 < uVar3; local_28 = local_28 + 1) {
    uVar2 = std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[]
                      (param_2,(long)local_28);
    std::__cxx11::string::length(param_3);
                    /* try { // try from 0010228c to 001022db has its CatchHandler @ 001022e0 */
    std::__cxx11::string::substr((ulong)local_48,uVar2);
...

{
  ...
  if (lVar2 == lVar3) {
    ...
    uVar6 = __cxx11::string::size(param_1);
                    /* try { // try from 001023f5 to 001023f9 has its CatchHandler @ 00102418 */
...
{
                    /* try { // try from 00102534 to 00102538 has its CatchHandler @ 0010254a */
  _M_dispose(this);
...

{
  ...
  _Vector_base<std::__cxx11::string,std::allocator<std::__cxx11::string>>::_M_get_Tp_allocator
            ((_Vector_base<std::__cxx11::string,std::allocator<std::__cxx11::string>> *)this);
                    /* try { // try from 00102634 to 00102638 has its CatchHandler @ 0010264c */
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 001027c8 to 001027cc has its CatchHandler @ 0010280e */
...
{
                    /* try { // try from 001028f2 to 001028f6 has its CatchHandler @ 00102908 */
...

{
  ...
  local_28 = &local_49;
  local_10 = local_28;
                    /* try { // try from 00102b06 to 00102b0a has its CatchHandler @ 00102b97 */
  ...
  lVar2 = _M_data(local_38);
                    /* try { // try from 00102b36 to 00102b8b has its CatchHandler @ 00102bb6 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 00102c3e to 00102c7b has its CatchHandler @ 00102c93 */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00102e02 to 00102e1d has its CatchHandler @ 00102e32 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 001030b1 to 001030b5 has its CatchHandler @ 001030c0 */
...

{
  ...
  local_38 = this;
  local_20 = local_58;
                    /* try { // try from 00103408 to 0010340c has its CatchHandler @ 001034eb */
...

{
  ...
  local_18 = local_48;
  local_10 = local_40;
                    /* try { // try from 00103599 to 0010359d has its CatchHandler @ 001035eb */
  ...
  uVar2 = length(local_68);
                    /* try { // try from 001035db to 001035df has its CatchHandler @ 0010360a */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00103919 to 0010391d has its CatchHandler @ 00103928 */
...

{
  ...
  paVar3 = (allocator *)_M_get_allocator(param_1);
                    /* try { // try from 00103bd5 to 00103c96 has its CatchHandler @ 00103c9f */
