...
/* WARNING: Removing unreachable block (ram,0x0010139b) */
/* sort_third(std::vector<int, std::allocator<int> >) */

vector<int,std::allocator<int>> *
sort_third(vector<int,std::allocator<int>> *param_1,vector<int,std::allocator<int>> *param_2)

{
  ...
  for (local_34 = 0; uVar1 = std::vector<int,std::allocator<int>>::size(param_2),
      (ulong)(long)(local_34 * 3) < uVar1; local_34 = local_34 + 1) {
    piVar2 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)(local_34 * 3));
                    /* try { // try from 00101268 to 001012bb has its CatchHandler @ 00101280 */
    std::vector<int,std::allocator<int>>::push_back(local_30,piVar2);
  }
  uVar3 = std::vector<int,std::allocator<int>>::begin(local_30);
  std::vector<int,std::allocator<int>>::end(local_30);
  std::sort<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>>(uVar3);
  memset(param_1,0,0x18);
  std::vector<int,std::allocator<int>>::vector(param_1);
  for (local_34 = 0; uVar1 = std::vector<int,std::allocator<int>>::size(param_2),
      (ulong)(long)local_34 < uVar1; local_34 = local_34 + 1) {
    if (local_34 % 3 == 0) {
      piVar2 = (int *)std::vector<int,std::allocator<int>>::operator[]
                                (local_30,(long)(local_34 / 3));
                    /* try { // try from 00101344 to 0010137c has its CatchHandler @ 0010134d */
      std::vector<int,std::allocator<int>>::push_back(param_1,piVar2);
    }
    else {
      piVar2 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_34);
      std::vector<int,std::allocator<int>>::push_back(param_1,piVar2);
    }
  }
  std::vector<int,std::allocator<int>>::~vector(local_30);
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00101bf9 to 00101bfd has its CatchHandler @ 00101c08 */
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 00101cb6 to 00101cc2 has its CatchHandler @ 00101cd6 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
