...
{
  (*(code *)PTR___throw_bad_alloc_00104008)();
  return;
}
...
{
  (*(code *)PTR___throw_length_error_00104018)();
  return;
}
...

{
  ...
  pvVar1 = (void *)(*(code *)PTR_memset_00104020)();
  return pvVar1;
}
...
/* WARNING: Removing unreachable block (ram,0x00101285) */
/* factorize(int) */

vector<int,std::allocator<int>> * factorize(int param_1)

{
  ...
  for (local_1c = 2; local_1c * local_1c <= local_14; local_1c = local_1c + 1) {
    if (local_14 % local_1c == 0) {
      local_14 = local_14 / local_1c;
                    /* try { // try from 00101232 to 00101278 has its CatchHandler @ 00101248 */
      std::vector<int,std::allocator<int>>::push_back(this,&local_1c);
      local_1c = local_1c + -1;
    }
  }
  std::vector<int,std::allocator<int>>::push_back(this,&local_14);
  return this;
}
...
{
                    /* try { // try from 00101482 to 00101486 has its CatchHandler @ 00101498 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 001019e9 to 001019ed has its CatchHandler @ 001019f8 */
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 00101ad6 to 00101ae2 has its CatchHandler @ 00101af6 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
