...
/* valid_date(std::__cxx11::string) */

undefined1 valid_date(string *param_1)
  ...
  if (lVar1 == 10) {
    for (local_2c = 0; local_2c < 10; local_2c = local_2c + 1) {
      if ((local_2c == 2) || (local_2c == 5)) {
        pcVar2 = (char *)std::__cxx11::string::operator[](param_1,(long)local_2c);
        if (*pcVar2 != '-') {
          return 0;
        }
      }
        ...
        pcVar2 = (char *)std::__cxx11::string::operator[](param_1,(long)local_2c);
        if ((*pcVar2 < '0') ||
           (pcVar2 = (char *)std::__cxx11::string::operator[](param_1,(long)local_2c), '9' < *pcVar2
           )) {
          return 0;
        }
      }
    ...
    pcVar2 = (char *)std::__cxx11::string::c_str(local_50);
    local_1c = atoi(pcVar2);
    std::__cxx11::string::~string(local_50);
    std::__cxx11::string::substr((ulong)local_70,(ulong)param_1);
    pcVar2 = (char *)std::__cxx11::string::c_str(local_70);
    local_20 = atoi(pcVar2);
    std::__cxx11::string::~string(local_70);
    std::__cxx11::string::substr((ulong)local_90,(ulong)param_1);
    pcVar2 = (char *)std::__cxx11::string::c_str(local_90);
    local_24 = atoi(pcVar2);
    std::__cxx11::string::~string(local_90);
    if ((local_1c < 1) || (0xc < local_1c)) {
      local_9 = 0;
    }
    else if ((local_20 < 1) || (0x1f < local_20)) {
      local_9 = 0;
    }
    else if ((local_20 == 0x1f) &&
            ((((local_1c == 4 || (local_1c == 6)) || (local_1c == 9)) ||
             ((local_1c == 0xb || (local_1c == 2)))))) {
      local_9 = 0;
    }
    else if ((local_20 == 0x1e) && (local_1c == 2)) {
      local_9 = 0;
    }
    else {
      local_9 = 1;
...

{
  undefined8 uVar1;
                    ...
                    /* try { // try from 001024e0 to 001024e4 has its CatchHandler @ 001024f5 */
  uVar1 = _M_data(this);
  return uVar1;
}
...
{
                    /* try { // try from 00102514 to 00102518 has its CatchHandler @ 0010252a */
  _M_dispose(this);
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 00102648 to 0010264c has its CatchHandler @ 0010268e */
