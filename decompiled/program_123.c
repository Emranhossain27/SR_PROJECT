...
/* WARNING: Removing unreachable block (ram,0x001012e2) */
/* get_odd_collatz(int) */

vector<int,std::allocator<int>> * get_odd_collatz(int param_1)

{
  ...
  local_30 = this;
  local_10 = local_28;
                    /* try { // try from 00101220 to 00101224 has its CatchHandler @ 00101269 */
  std::vector<int,std::allocator<int>>::vector(this,local_48,1);
  local_20 = &local_4d;
  std::__new_allocator<int>::~__new_allocator(local_20);
  while (local_34 != 1) {
    if (local_34 % 2 == 1) {
                    /* try { // try from 0010124e to 001012d5 has its CatchHandler @ 00101288 */
      std::vector<int,std::allocator<int>>::push_back(this,&local_34);
      local_34 = local_34 * 3 + 1;
    }
    else {
      local_34 = local_34 / 2;
    }
  }
  uVar1 = std::vector<int,std::allocator<int>>::begin(this);
...

{
  ...
  uVar3 = initializer_list<int>::size((initializer_list<int> *)&local_18);
                    /* try { // try from 0010137f to 00101383 has its CatchHandler @ 0010138c */
...
{
                    /* try { // try from 001016c2 to 001016c6 has its CatchHandler @ 001016d8 */
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 00101906 to 00101912 has its CatchHandler @ 00101926 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00101e69 to 00101e6d has its CatchHandler @ 00101e78 */
