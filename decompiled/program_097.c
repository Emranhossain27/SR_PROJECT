...
vector<int,std::allocator<int>> * count_up_to(int param_1)

{
  ...
  for (local_1c = 2; local_1c < local_14; local_1c = local_1c + 1) {
    ...
    if (lVar4 == 0) {
                    /* try { // try from 00101235 to 001012df has its CatchHandler @ 00101249 */
      ...
      while( true ) {
        ...
        piVar5 = (int *)std::vector<int,std::allocator<int>>::operator[](this,(long)local_20);
        iVar3 = local_1c;
        if (local_1c < iVar1 * *piVar5) break;
        piVar5 = (int *)std::vector<int,std::allocator<int>>::operator[](this,(long)local_20);
        if (iVar3 % *piVar5 == 0) {
          bVar2 = false;
        }
...
{
                    /* try { // try from 001015a2 to 001015a6 has its CatchHandler @ 001015b8 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00101b09 to 00101b0d has its CatchHandler @ 00101b18 */
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 00101bc6 to 00101bd2 has its CatchHandler @ 00101be6 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
