...
/* parse_nested_parens(std::__cxx11::string) */

vector<int,std::allocator<int>> *
parse_nested_parens(vector<int,std::allocator<int>> *param_1,string *param_2)

{
  ...
  local_44 = 0;
  local_48 = 0;
  for (local_50 = 0; uVar2 = std::__cxx11::string::length(param_2), (ulong)(long)local_50 < uVar2;
      local_50 = local_50 + 1) {
                    /* try { // try from 00102262 to 00102310 has its CatchHandler @ 00102298 */
    ...
    if (cVar1 == ')') {
      ...
      std::__cxx11::string::operator+=(local_40,')');
      if (local_44 == 0) {
        std::vector<int,std::allocator<int>>::push_back(param_1,&local_48);
        std::__cxx11::string::operator=(local_40,"");
        local_48 = 0;
      }
    }
...

{
  ...
  local_30 = this;
                    /* try { // try from 001023ab to 001023f6 has its CatchHandler @ 001023ff */
...
{
                    /* try { // try from 001029c2 to 001029c6 has its CatchHandler @ 001029d8 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 00102b1e to 00102b5b has its CatchHandler @ 00102b73 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 00102c74 to 00102c78 has its CatchHandler @ 00102cd4 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...
/* WARNING: Removing unreachable block (ram,0x00102fd6) */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 001034b9 to 001034bd has its CatchHandler @ 001034c8 */
