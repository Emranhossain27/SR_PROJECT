...
/* will_it_fly(std::vector<int, std::allocator<int> >, int) */

undefined8 will_it_fly(vector<int,std::allocator<int>> *param_1,int param_2)
...
LAB_001011f2:
    ...
    puVar3 = (uint *)std::vector<int,std::allocator<int>>::operator[](param_1,(long)local_24);
    uVar1 = *puVar3;
    lVar4 = std::vector<int,std::allocator<int>>::size(param_1);
    puVar3 = (uint *)std::vector<int,std::allocator<int>>::operator[]
                               (param_1,(lVar4 + -1) - (long)local_24);
    uVar2 = (ulong)uVar1;
    if (uVar1 != *puVar3) {
      local_9 = 0;
      goto LAB_001011f2;
    }
    piVar5 = (int *)std::vector<int,std::allocator<int>>::operator[](param_1,(long)local_24);
