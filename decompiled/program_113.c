...

{
  ...
  pvVar1 = (void *)(*(code *)PTR_memset_00109030)();
  return pvVar1;
}
...
{
  (*(code *)PTR___throw_out_of_range_fmt_00109060)();
  return;
}
...

{
  ...
  pvVar1 = (void *)(*(code *)PTR_memmove_00109068)();
  return pvVar1;
}
...
/* WARNING: Removing unreachable block (ram,0x00102637) */
/* odd_count(std::vector<std::__cxx11::string, std::allocator<std::__cxx11::string > >) */

vector<std::__cxx11::string,std::allocator<std::__cxx11::string>> *
odd_count(vector<std::__cxx11::string,std::allocator<std::__cxx11::string>> *param_1,
...

{
  ...
  for (local_60 = 0; uVar1 = (ulong)local_60,
    ...
    while( true ) {
      ...
      psVar3 = (string *)
               std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[]
                         (param_2,(long)local_60);
                    /* try { // try from 001022f3 to 00102363 has its CatchHandler @ 0010238f */
      pcVar4 = (char *)std::__cxx11::string::operator[](psVar3,(long)local_68);
      if ('/' < *pcVar4) {
        psVar3 = (string *)
                 std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[]
                           (param_2,(long)local_60);
        ...
        if (*pcVar4 < ':') {
          psVar3 = (string *)
                   ...
                   operator[](param_2,(long)local_60);
          pcVar4 = (char *)std::__cxx11::string::operator[](psVar3,(long)local_68);
          if ((int)*pcVar4 % 2 == 1) {
            local_64 = local_64 + 1;
          }
    ...
    local_48 = &local_99;
                    /* try { // try from 001023c3 to 001023d5 has its CatchHandler @ 001024f0 */
    local_10 = local_48;
    std::__cxx11::string::string<std::allocator<char>>
              (local_98,"the number of odd elements in the string i of the input.",local_48);
    local_38 = (__new_allocator<char> *)&local_99;
    std::__new_allocator<char>::~__new_allocator(local_38);
    local_40 = &local_c1;
                    /* try { // try from 001023ff to 00102411 has its CatchHandler @ 00102515 */
    local_18 = local_40;
    std::__cxx11::string::string<std::allocator<char>>(local_c0,"",local_40);
    local_28 = (__new_allocator<char> *)&local_c1;
    std::__new_allocator<char>::~__new_allocator(local_28);
    for (local_c8 = 0; uVar1 = (ulong)local_c8, uVar2 = std::__cxx11::string::length(local_98),
        uVar1 < uVar2; local_c8 = local_c8 + 1) {
                    /* try { // try from 00102466 to 00102471 has its CatchHandler @ 0010253a */
      pcVar4 = (char *)std::__cxx11::string::operator[](local_98,(long)local_c8);
      if (*pcVar4 == 'i') {
        std::__cxx11::to_string(local_108,local_64);
                    /* try { // try from 001024ab to 001024bd has its CatchHandler @ 0010254b */
        ...
        std::__cxx11::string::~string((string *)local_108);
                    ...
                    /* try { // try from 0010256f to 001025ea has its CatchHandler @ 0010253a */
        std::__cxx11::string::operator[](local_98,(long)local_c8);
        std::operator+(local_128,(char)local_c0);
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 00102828 to 0010287f has its CatchHandler @ 00102836 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 00102828 with catch @ 00102836 */
...

{
  ...
  psVar1 = (string *)__cxx11::string::insert(in_RDX,0,param_2);
...
/* WARNING: Removing unreachable block (ram,0x0010299e) */
...

{
  ...
  local_30 = CONCAT31(local_30._1_3_,bVar2);
                    /* try { // try from 0010298d to 00102991 has its CatchHandler @ 001029b1 */
...

{
  ...
  char *local_40;
                    ...
                    /* try { // try from 001029df to 00102ae4 has its CatchHandler @ 00102baa */
  _M_is_local(this);
...
{
                    /* try { // try from 00102bd4 to 00102bd8 has its CatchHandler @ 00102bea */
  _M_dispose(this);
  _Alloc_hider::~_Alloc_hider((_Alloc_hider *)this);
  return;
}
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 00102c5b to 00102c69 has its CatchHandler @ 00102c87 */
...

{
  ...
  _Vector_base<std::__cxx11::string,std::allocator<std::__cxx11::string>>::_M_get_Tp_allocator
            ((_Vector_base<std::__cxx11::string,std::allocator<std::__cxx11::string>> *)this);
                    /* try { // try from 00102d84 to 00102d88 has its CatchHandler @ 00102d9c */
...

{
  ...
  local_30 = this;
                    /* try { // try from 00102eeb to 00102f36 has its CatchHandler @ 00102f3f */
  pcVar1 = (char *)_M_local_data(this);
  local_28 = &local_31;
  local_10 = local_28;
...
{
                    /* try { // try from 00103247 to 0010324b has its CatchHandler @ 00103254 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 00103274 to 00103278 has its CatchHandler @ 001032d4 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...

{
  ...
  local_28 = this;
                    /* try { // try from 001034ee to 0010352b has its CatchHandler @ 00103543 */
...
/* WARNING: Removing unreachable block (ram,0x00103656) */
...
{
                    /* try { // try from 001038e2 to 001038e6 has its CatchHandler @ 001038f8 */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00103b82 to 00103b9d has its CatchHandler @ 00103bb2 */
...

{
  ...
  paVar3 = (allocator *)_M_get_allocator(param_1);
                    /* try { // try from 00103d05 to 00103dc6 has its CatchHandler @ 00103dcf */
...
{
                    /* try { // try from 001044a0 to 001044a8 has its CatchHandler @ 001044b1 */
  _M_set_length(this,0);
  return;
}
...
/* WARNING: Removing unreachable block (ram,0x0010459f) */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 00104562 to 00104592 has its CatchHandler @ 001045a1 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 00104688 to 0010469f has its CatchHandler @ 001046a8 */
...

{
  ...
  local_38 = this;
  local_20 = local_58;
                    /* try { // try from 00104908 to 0010490c has its CatchHandler @ 001049eb */
...

{
  ...
  local_18 = local_48;
  local_10 = local_40;
                    /* try { // try from 00104a99 to 00104a9d has its CatchHandler @ 00104aeb */
  ...
  uVar2 = length(local_68);
                    /* try { // try from 00104adb to 00104adf has its CatchHandler @ 00104b0a */
...
/* WARNING: Removing unreachable block (ram,0x00104b94) */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00104e19 to 00104e1d has its CatchHandler @ 00104e28 */
