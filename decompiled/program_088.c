...
/* WARNING: Removing unreachable block (ram,0x0010138a) */
/* get_row(std::vector<std::vector<int, std::allocator<int> >, std::allocator<std::vector<int,
   std::allocator<int> > > >, int) */

vector<std::vector<int,std::allocator<int>>,std::allocator<std::vector<int,std::allocator<int>>>> *
get_row(vector<std::vector<int,std::allocator<int>>,std::allocator<std::vector<int,std::allocator<int>>>>
        *param_1,
       vector<std::vector<int,std::allocator<int>>,std::allocator<std::vector<int,std::allocator<int>>>>
       *param_2,int param_3)

{
  ...
  int *piVar4;
  __new_allocator<int> local_79;
  int local_78;
  int local_74;
  int *local_70;
  undefined8 local_68;
  vector<int,std::allocator<int>> local_60 [24];
  int local_48;
  int local_44;
  undefined1 local_3d;
  int local_3c;
  ...
  *local_30;
  ...
  vector<std::vector<int,std::allocator<int>>,std::allocator<std::vector<int,std::allocator<int>>>>
  ::vector(param_1);
  for (local_44 = 0; uVar1 = (ulong)local_44,
      uVar2 = std::
              vector<std::vector<int,std::allocator<int>>,std::allocator<std::vector<int,std::allocator<int>>>>
              ::size(param_2), uVar1 < uVar2; local_44 = local_44 + 1) {
    pvVar3 = (vector<int,std::allocator<int>> *)
             std::
             vector<std::vector<int,std::allocator<int>>,std::allocator<std::vector<int,std::allocator<int>>>>
             ::operator[](param_2,(long)local_44);
    local_48 = std::vector<int,std::allocator<int>>::size(pvVar3);
    while (local_48 = local_48 + -1, -1 < local_48) {
      pvVar3 = (vector<int,std::allocator<int>> *)
               std::
               vector<std::vector<int,std::allocator<int>>,std::allocator<std::vector<int,std::allocator<int>>>>
               ::operator[](param_2,(long)local_44);
      piVar4 = (int *)std::vector<int,std::allocator<int>>::operator[](pvVar3,(long)local_48);
      if (*piVar4 == local_3c) {
        local_78 = local_44;
        local_74 = local_48;
        local_70 = &local_78;
        local_68 = 2;
        local_28 = &local_79;
                    /* try { // try from 001012df to 001012e7 has its CatchHandler @ 00101318 */
        local_10 = local_28;
        std::vector<int,std::allocator<int>>::vector(local_60,local_70,2);
                    /* try { // try from 001012ea to 001012f9 has its CatchHandler @ 00101329 */
        std::
        vector<std::vector<int,std::allocator<int>>,std::allocator<std::vector<int,std::allocator<int>>>>
...

{
  ...
  uVar3 = initializer_list<int>::size((initializer_list<int> *)&local_18);
                    /* try { // try from 001015df to 001015e3 has its CatchHandler @ 001015ec */
...

{
  ...
  ::_M_get_Tp_allocator
            ((_Vector_base<std::vector<int,std::allocator<int>>,std::allocator<std::vector<int,std::allocator<int>>>>
              *)this);
                    /* try { // try from 001016b4 to 001016b8 has its CatchHandler @ 001016cc */
...
{
                    /* try { // try from 001017b0 to 001017b4 has its CatchHandler @ 001017c6 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00101fc9 to 00101fcd has its CatchHandler @ 00101fd8 */
    _Vector_base<std::vector<int,std::allocator<int>>,std::allocator<std::vector<int,std::allocator<int>>>>
    ::_M_deallocate(*(_Vector_base<std::vector<int,std::allocator<int>>,std::allocator<std::vector<int,std::allocator<int>>>>
...

{
  ...
  local_38[0] = 0x555555555555555;
                    /* try { // try from 00102086 to 00102092 has its CatchHandler @ 001020a6 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
...
{
                    /* try { // try from 001024f2 to 001024f6 has its CatchHandler @ 00102508 */
