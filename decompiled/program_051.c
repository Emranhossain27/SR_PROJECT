...
/* encode_shift(std::__cxx11::string) */

string * encode_shift(string *param_1,string *param_2)

{
  ...
  for (local_20 = 0; uVar1 = (ulong)local_20, uVar2 = std::__cxx11::string::length(param_2),
    ...
    local_24 = *pcVar3 + 5 + ((*pcVar3 + -0x5c) / 0x1a) * -0x1a;
...
/* WARNING: Removing unreachable block (ram,0x001023e9) */
/* decode_shift(std::__cxx11::string) */

string * decode_shift(string *param_1,string *param_2)

{
  ...
  for (local_20 = 0; uVar1 = (ulong)local_20, uVar2 = std::__cxx11::string::length(param_2),
      uVar1 < uVar2; local_20 = local_20 + 1) {
                    /* try { // try from 0010234b to 001023a1 has its CatchHandler @ 001023c8 */
    pcVar3 = (char *)std::__cxx11::string::operator[](param_2,(long)local_20);
    local_24 = *pcVar3 + 0x15 + ((*pcVar3 + -0x4c) / 0x1a) * -0x1a;
    std::operator+(local_58,(char)param_1);
    std::__cxx11::string::operator=(param_1,local_58);
    std::__cxx11::string::~string(local_58);
  }
...

{
  ...
  local_30 = this;
                    /* try { // try from 0010243b to 00102486 has its CatchHandler @ 0010248f */
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 0010259b to 001025a9 has its CatchHandler @ 001025c7 */
...

{
  ...
  char *local_40;
                    ...
                    /* try { // try from 0010260f to 00102714 has its CatchHandler @ 001027da */
  _M_is_local(this);
...
{
                    /* try { // try from 00102804 to 00102808 has its CatchHandler @ 0010281a */
  _M_dispose(this);
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 00102a48 to 00102a4c has its CatchHandler @ 00102a8e */
...
/* WARNING: Removing unreachable block (ram,0x00102cff) */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 00102cc2 to 00102cf2 has its CatchHandler @ 00102d01 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 00102de8 to 00102dff has its CatchHandler @ 00102e08 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 00102f54 to 00102f58 has its CatchHandler @ 00102fb4 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...
/* WARNING: Removing unreachable block (ram,0x00103196) */
...
{
                    /* try { // try from 00103460 to 00103468 has its CatchHandler @ 00103471 */
  _M_set_length(this,0);
  return;
}
