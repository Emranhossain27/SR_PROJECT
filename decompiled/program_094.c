...
/* WARNING: Removing unreachable block (ram,0x001024fa) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* encode(std::__cxx11::string) */

string * encode(string *param_1,string *param_2)

{
  ...
  local_68 = &local_99;
                    /* try { // try from 0010223e to 00102250 has its CatchHandler @ 00102341 */
  local_78 = param_2;
  local_70 = param_1;
  local_10 = local_68;
  std::__cxx11::string::string<std::allocator<char>>(local_98,"aeiouAEIOU",local_68);
  local_58 = (__new_allocator<char> *)&local_99;
  std::__new_allocator<char>::~__new_allocator(local_58);
  local_ad = 0;
  local_60 = &local_ae;
  local_18 = local_60;
                    /* try { // try from 00102288 to 00102293 has its CatchHandler @ 0010236c */
  std::__cxx11::string::string<std::allocator<char>>(param_1,"",local_60);
  local_48 = (__new_allocator<char> *)&local_ae;
  std::__new_allocator<char>::~__new_allocator(local_48);
  for (local_b4 = 0; uVar1 = (ulong)local_b4, uVar2 = std::__cxx11::string::length(param_2),
      uVar1 < uVar2; local_b4 = local_b4 + 1) {
                    /* try { // try from 001022ef to 001024b4 has its CatchHandler @ 00102397 */
    pcVar3 = (char *)std::__cxx11::string::operator[](param_2,(long)local_b4);
    local_b5 = *pcVar3;
    if ((local_b5 < 'a') || ('z' < local_b5)) {
      if (('@' < local_b5) && (local_b5 < '[')) {
        local_b5 = local_b5 + ' ';
      }
    }
    else {
      local_b5 = local_b5 + -0x20;
    }
    local_c8 = std::__cxx11::string::begin(local_98);
    local_d0 = std::__cxx11::string::end(local_98);
    local_c0 = std::find<__gnu_cxx::__normal_iterator<char*,std::__cxx11::string>,char>
                         (local_c8,local_d0,&local_b5);
    local_d8 = std::__cxx11::string::end(local_98);
    local_30 = &local_c0;
    local_38 = &local_d8;
    if (local_c0 != local_d8) {
      local_b5 = local_b5 + '\x02';
    }
    local_28 = local_38;
    local_20 = local_30;
    std::operator+(local_f8,(char)param_1);
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 001028fb to 00102909 has its CatchHandler @ 00102927 */
...
/* WARNING: Removing unreachable block (ram,0x00102988) */
...

{
  ...
  char *local_40;
                    ...
                    /* try { // try from 0010296f to 00102a74 has its CatchHandler @ 00102b3a */
  _M_is_local(this);
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 00102c88 to 00102c8c has its CatchHandler @ 00102cce */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00102ea2 to 00102ebd has its CatchHandler @ 00102ed2 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 001030e1 to 001030e5 has its CatchHandler @ 001030f0 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 0010311e to 0010315b has its CatchHandler @ 00103173 */
...
/* WARNING: Removing unreachable block (ram,0x0010346f) */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 00103432 to 00103462 has its CatchHandler @ 00103471 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 00103558 to 0010356f has its CatchHandler @ 00103578 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 00103684 to 00103688 has its CatchHandler @ 001036e4 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...
{
                    /* try { // try from 00103940 to 00103948 has its CatchHandler @ 00103951 */
  _M_set_length(this,0);
  return;
}
