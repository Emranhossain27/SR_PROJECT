...
/* fix_spaces(std::__cxx11::string) */

string * fix_spaces(string *param_1,string *param_2)

{
  ...
  local_30 = param_1;
  local_10 = local_28;
                    /* try { // try from 0010222f to 0010223a has its CatchHandler @ 001022bc */
  std::__cxx11::string::string<std::allocator<char>>(param_1,"",local_28);
  ...
  while( true ) {
    ...
    if (uVar2 <= uVar1) break;
                    /* try { // try from 00102291 to 001024bc has its CatchHandler @ 001022de */
    pcVar3 = (char *)std::__cxx11::string::operator[](param_2,(long)local_54);
    if (*pcVar3 == ' ') {
      local_50 = local_50 + 1;
    }
    else {
      if (local_50 == 1) {
        std::operator+(local_78,cVar4);
        std::__cxx11::string::operator=(param_1,local_78);
        std::__cxx11::string::~string(local_78);
      }
      if (local_50 == 2) {
        std::operator+(local_98,(char *)param_1);
        std::__cxx11::string::operator=(param_1,local_98);
        std::__cxx11::string::~string(local_98);
      }
      if (2 < local_50) {
        std::operator+(local_b8,cVar4);
        std::__cxx11::string::operator=(param_1,local_b8);
        std::__cxx11::string::~string(local_b8);
      }
      local_50 = 0;
      std::__cxx11::string::operator[](param_2,(long)local_54);
      std::operator+(local_d8,cVar4);
  ...
  if (local_50 == 1) {
    std::operator+(local_f8,cVar4);
    std::__cxx11::string::operator=(param_1,local_f8);
    std::__cxx11::string::~string(local_f8);
  }
  if (local_50 == 2) {
    std::operator+(local_118,(char *)param_1);
    std::__cxx11::string::operator=(param_1,local_118);
    std::__cxx11::string::~string(local_118);
  }
  if (2 < local_50) {
    std::operator+(local_138,cVar4);
    std::__cxx11::string::operator=(param_1,local_138);
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 001026cb to 001026d9 has its CatchHandler @ 001026f7 */
...

{
  ...
  char *local_40;
                    ...
                    /* try { // try from 0010273f to 00102844 has its CatchHandler @ 0010290a */
  _M_is_local(this);
...
{
                    /* try { // try from 00102934 to 00102938 has its CatchHandler @ 0010294a */
  _M_dispose(this);
  _Alloc_hider::~_Alloc_hider((_Alloc_hider *)this);
  return;
}
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 001029d6 to 001029da has its CatchHandler @ 001029fb */
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 00102b28 to 00102b2c has its CatchHandler @ 00102b6e */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00102d42 to 00102d5d has its CatchHandler @ 00102d72 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00102f81 to 00102f85 has its CatchHandler @ 00102f90 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 00102fbe to 00102ffb has its CatchHandler @ 00103013 */
...
/* WARNING: Removing unreachable block (ram,0x0010330f) */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 001032d2 to 00103302 has its CatchHandler @ 00103311 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 001033f8 to 0010340f has its CatchHandler @ 00103418 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 00103524 to 00103528 has its CatchHandler @ 00103584 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...
{
                    /* try { // try from 001037e0 to 001037e8 has its CatchHandler @ 001037f1 */
  _M_set_length(this,0);
  return;
}
