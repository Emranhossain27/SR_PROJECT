...
/* all_prefixes(std::__cxx11::string) */

vector<std::__cxx11::string,std::allocator<std::__cxx11::string>> *
all_prefixes(vector<std::__cxx11::string,std::allocator<std::__cxx11::string>> *param_1,
            string *param_2)

{
  ...
  local_28 = &local_61;
                    /* try { // try from 00102234 to 00102243 has its CatchHandler @ 0010230c */
  local_10 = local_28;
  std::__cxx11::string::string<std::allocator<char>>(local_60,"",local_28);
  ...
  while( true ) {
    ...
    if (uVar2 <= uVar1) break;
                    /* try { // try from 00102293 to 001022f9 has its CatchHandler @ 0010232b */
    std::__cxx11::string::operator[](param_2,(long)local_78);
    std::operator+(local_98,(char)local_60);
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 001023f8 to 0010244f has its CatchHandler @ 00102406 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 001023f8 with catch @ 00102406 */
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 001024eb to 001024f9 has its CatchHandler @ 00102517 */
...

{
  ...
  char *local_40;
                    ...
                    /* try { // try from 001025df to 001026e4 has its CatchHandler @ 001027aa */
  _M_is_local(this);
...
{
                    /* try { // try from 001027d4 to 001027d8 has its CatchHandler @ 001027ea */
  _M_dispose(this);
  _Alloc_hider::~_Alloc_hider((_Alloc_hider *)this);
  return;
}
...

{
  ...
  _Vector_base<std::__cxx11::string,std::allocator<std::__cxx11::string>>::_M_get_Tp_allocator
            ((_Vector_base<std::__cxx11::string,std::allocator<std::__cxx11::string>> *)this);
                    /* try { // try from 001028d4 to 001028d8 has its CatchHandler @ 001028ec */
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 00102a78 to 00102a7c has its CatchHandler @ 00102abe */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00102e12 to 00102e2d has its CatchHandler @ 00102e42 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00103051 to 00103055 has its CatchHandler @ 00103060 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 0010308e to 001030cb has its CatchHandler @ 001030e3 */
...
/* WARNING: Removing unreachable block (ram,0x001031b6) */
...
/* WARNING: Removing unreachable block (ram,0x001033df) */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 001033a2 to 001033d2 has its CatchHandler @ 001033e1 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 001034c8 to 001034df has its CatchHandler @ 001034e8 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 001035f4 to 001035f8 has its CatchHandler @ 00103654 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...
{
                    /* try { // try from 001038b0 to 001038b8 has its CatchHandler @ 001038c1 */
  _M_set_length(this,0);
  return;
}
...

{
  ...
  local_38 = this;
  local_20 = local_58;
                    /* try { // try from 00103a18 to 00103a1c has its CatchHandler @ 00103afb */
...

{
  ...
  local_18 = local_48;
  local_10 = local_40;
                    /* try { // try from 00103ba9 to 00103bad has its CatchHandler @ 00103bfb */
  ...
  uVar2 = length(local_68);
                    /* try { // try from 00103beb to 00103bef has its CatchHandler @ 00103c1a */
...
/* WARNING: Removing unreachable block (ram,0x00103ce4) */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00103f69 to 00103f6d has its CatchHandler @ 00103f78 */
...

{
  ...
  paVar3 = (allocator *)_M_get_allocator(param_1);
                    /* try { // try from 00104255 to 00104316 has its CatchHandler @ 0010431f */
