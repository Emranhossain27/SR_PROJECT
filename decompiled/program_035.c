...
/* WARNING: Removing unreachable block (ram,0x00101367) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* unique(std::vector<int, std::allocator<int> >) */

vector<int,std::allocator<int>> *
unique(vector<int,std::allocator<int>> *param_1,vector<int,std::allocator<int>> *param_2)

{
  ...
  for (local_40 = 0; uVar1 = (ulong)local_40,
      uVar2 = std::vector<int,std::allocator<int>>::size(param_2), uVar1 < uVar2;
      local_40 = local_40 + 1) {
    local_50 = std::vector<int,std::allocator<int>>::begin(param_1);
    local_58 = std::vector<int,std::allocator<int>>::end(param_1);
    uVar3 = std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_40);
                    /* try { // try from 00101297 to 0010135a has its CatchHandler @ 0010130d */
    local_48 = std::
               find<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>,int>
                         (local_50,local_58,uVar3);
    local_70[0] = std::vector<int,std::allocator<int>>::end(param_1);
    local_20 = &local_48;
    local_28 = local_70;
    local_18 = local_28;
    local_10 = local_20;
    if (local_48 == local_70[0]) {
      piVar4 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_40);
...
{
                    /* try { // try from 00101702 to 00101706 has its CatchHandler @ 00101718 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00101d29 to 00101d2d has its CatchHandler @ 00101d38 */
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 00101de6 to 00101df2 has its CatchHandler @ 00101e06 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
