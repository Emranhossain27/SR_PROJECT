...
/* Strongest_Extension(std::__cxx11::string, std::vector<std::__cxx11::string,
   std::allocator<std::__cxx11::string > >) */

string * Strongest_Extension(string *param_1,undefined8 param_2,
...

{
  ...
  local_28 = &local_61;
                    /* try { // try from 00102236 to 00102245 has its CatchHandler @ 00102323 */
  local_40 = param_3;
  local_38 = param_2;
  local_30 = param_1;
  local_10 = local_28;
  ...
  while( true ) {
    ...
    while( true ) {
      ...
      psVar3 = (string *)
               std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[]
                         (param_3,(long)local_7c);
                    /* try { // try from 001022ec to 001023d6 has its CatchHandler @ 00102345 */
      pcVar4 = (char *)std::__cxx11::string::operator[](psVar3,(long)local_84);
      local_85 = *pcVar4;
      if (('@' < local_85) && (local_85 < '[')) {
        local_80 = local_80 + 1;
      }
      if (('`' < local_85) && (local_85 < '{')) {
        local_80 = local_80 + -1;
    ...
    if (local_78 < local_80) {
      ...
      psVar3 = (string *)
               std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[]
                         (param_3,(long)local_7c);
      std::__cxx11::string::operator=(local_60,psVar3);
    }
    local_7c = local_7c + 1;
  }
  std::operator+(local_a8,(char)param_2);
                    /* try { // try from 001023d9 to 001023ef has its CatchHandler @ 00102417 */
  std::operator+(param_1,local_a8);
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 0010273b to 00102749 has its CatchHandler @ 00102767 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 001030e4 to 001030e8 has its CatchHandler @ 00103144 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...
/* WARNING: Removing unreachable block (ram,0x0010322f) */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 001031f2 to 00103222 has its CatchHandler @ 00103231 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 00103318 to 0010332f has its CatchHandler @ 00103338 */
...

{
  ...
  paVar3 = (allocator *)_M_get_allocator(param_1);
                    /* try { // try from 001036f5 to 001037b6 has its CatchHandler @ 001037bf */
