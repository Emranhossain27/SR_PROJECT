...
/* below_threshold(std::vector<int, std::allocator<int> >, int) */

undefined8 below_threshold(vector<int,std::allocator<int>> *param_1,int param_2)
...
LAB_001011a2:
    ...
    puVar3 = (uint *)std::vector<int,std::allocator<int>>::operator[](param_1,(long)local_20);
    uVar1 = (ulong)*puVar3;
