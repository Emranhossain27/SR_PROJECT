...
/* WARNING: Removing unreachable block (ram,0x001012ed) */
/* strange_sort_list(std::vector<int, std::allocator<int> >) */

vector<int,std::allocator<int>> *
strange_sort_list(vector<int,std::allocator<int>> *param_1,vector<int,std::allocator<int>> *param_2)

{
  ...
  *(undefined8 *)(param_1 + 0x10) = 0;
  ...
  uVar2 = std::vector<int,std::allocator<int>>::end(param_2);
                    /* try { // try from 00101238 to 001012de has its CatchHandler @ 001012a7 */
  std::sort<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>>(uVar1,uVar2);
  local_40 = 0;
  local_44 = std::vector<int,std::allocator<int>>::size(param_2);
...
{
                    /* try { // try from 00101632 to 00101636 has its CatchHandler @ 00101648 */
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 001038f6 to 00103902 has its CatchHandler @ 00103916 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
