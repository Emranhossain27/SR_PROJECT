...
/* WARNING: Removing unreachable block (ram,0x001023eb) */
/* solve[abi:cxx11](int) */

string * solve_abi_cxx11_(int param_1)

{
  ...
  local_28 = &local_5a;
  local_10 = local_28;
                    /* try { // try from 00102237 to 00102242 has its CatchHandler @ 001022fe */
  std::__cxx11::string::string<std::allocator<char>>(this,"",local_28);
  local_20 = (__new_allocator<char> *)&local_5a;
  std::__new_allocator<char>::~__new_allocator(local_20);
  std::__cxx11::to_string(local_90,local_34);
  std::__cxx11::string::operator=(local_58,(string *)local_90);
  std::__cxx11::string::~string((string *)local_90);
  local_98 = 0;
  for (local_9c = 0; uVar1 = (ulong)local_9c, uVar2 = std::__cxx11::string::length(local_58),
      uVar1 < uVar2; local_9c = local_9c + 1) {
                    /* try { // try from 001022c2 to 001022ca has its CatchHandler @ 00102320 */
    pcVar3 = (char *)std::__cxx11::string::operator[](local_58,(long)local_9c);
    local_98 = *pcVar3 + -0x30 + local_98;
  }
  for (; 0 < local_98; local_98 = local_98 / 2) {
    std::__cxx11::to_string(local_e0,local_98 % 2);
                    /* try { // try from 00102375 to 00102380 has its CatchHandler @ 001023c7 */
    std::operator+(local_c0,(string *)local_e0);
    std::__cxx11::string::operator=(this,local_c0);
...

{
  ...
  local_30 = this;
                    /* try { // try from 0010245b to 001024a6 has its CatchHandler @ 001024af */
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 001024f8 to 0010254f has its CatchHandler @ 00102506 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 001024f8 with catch @ 00102506 */
...

{
  ...
  local_30 = CONCAT31(local_30._1_3_,bVar2);
                    /* try { // try from 0010260d to 00102611 has its CatchHandler @ 00102631 */
...

{
  ...
  char *local_40;
                    ...
                    /* try { // try from 0010265f to 00102764 has its CatchHandler @ 0010282a */
  _M_is_local(this);
...
{
                    /* try { // try from 00102854 to 00102858 has its CatchHandler @ 0010286a */
  _M_dispose(this);
  _Alloc_hider::~_Alloc_hider((_Alloc_hider *)this);
  return;
}
...
{
                    /* try { // try from 00102c07 to 00102c0b has its CatchHandler @ 00102c14 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 00102c34 to 00102c38 has its CatchHandler @ 00102c94 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...

{
  ...
  local_28 = this;
                    /* try { // try from 00102eae to 00102eeb has its CatchHandler @ 00102f03 */
...

{
  ...
  this_00 = (__new_allocator<char> *)_M_get_allocator(this);
                    /* try { // try from 001030d5 to 001030d9 has its CatchHandler @ 00103113 */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00103492 to 001034ad has its CatchHandler @ 001034c2 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00103561 to 00103565 has its CatchHandler @ 00103570 */
...
{
                    /* try { // try from 001035d0 to 001035d8 has its CatchHandler @ 001035e1 */
  _M_set_length(this,0);
  return;
}
...

{
  ...
  paVar3 = (allocator *)_M_get_allocator(param_1);
                    /* try { // try from 00103675 to 00103736 has its CatchHandler @ 0010373f */
