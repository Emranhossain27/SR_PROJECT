...
/* add_elements(std::vector<int, std::allocator<int> >, int) */

int add_elements(vector<int,std::allocator<int>> *param_1,int param_2)

{
  ...
  for (local_1c = 0; local_1c < param_2; local_1c = local_1c + 1) {
    piVar1 = (int *)std::vector<int,std::allocator<int>>::operator[](param_1,(long)local_1c);
    if (-100 < *piVar1) {
      piVar1 = (int *)std::vector<int,std::allocator<int>>::operator[](param_1,(long)local_1c);
      if (*piVar1 < 100) {
        piVar1 = (int *)std::vector<int,std::allocator<int>>::operator[](param_1,(long)local_1c);
