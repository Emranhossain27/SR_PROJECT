...
/* WARNING: Removing unreachable block (ram,0x001029be) */
/* bf(std::__cxx11::string, std::__cxx11::string) */

vector<std::__cxx11::string,std::allocator<std::__cxx11::string>> *
bf(vector<std::__cxx11::string,std::allocator<std::__cxx11::string>> *param_1,string *param_2,
  string *param_3)

{
  ...
  int local_298;
  int local_294;
  __new_allocator<std::__cxx11::string> local_28d;
  ...
  vector<std::__cxx11::string,std::allocator<std::__cxx11::string>> local_158 [24];
  string *local_140;
  string *local_138;
  ...
  allocator *local_f8;
  allocator *local_f0;
  __new_allocator<std::__cxx11::string> *local_e8;
  __new_allocator<std::__cxx11::string> *local_e0;
  ...
  local_130 = param_1;
  local_10 = local_128;
                    /* try { // try from 0010227d to 00102288 has its CatchHandler @ 001025fe */
  std::__cxx11::string::string<std::allocator<char>>(local_270,"Mercury",local_128);
  local_270 = local_248;
  local_120 = local_285;
  local_18 = local_120;
                    /* try { // try from 001022b2 to 001022bd has its CatchHandler @ 00102615 */
  std::__cxx11::string::string<std::allocator<char>>(local_270,"Venus",local_120);
  local_270 = local_228;
  local_118 = &local_286;
  local_20 = local_118;
                    /* try { // try from 001022e7 to 001022f2 has its CatchHandler @ 0010262c */
  std::__cxx11::string::string<std::allocator<char>>(local_270,"Earth",local_118);
  local_270 = local_208;
  local_110 = &local_287;
  local_28 = local_110;
                    /* try { // try from 0010231c to 00102327 has its CatchHandler @ 00102643 */
  std::__cxx11::string::string<std::allocator<char>>(local_270,"Mars",local_110);
  local_270 = local_1e8;
  local_108 = &local_288;
  local_30 = local_108;
                    /* try { // try from 00102351 to 0010235c has its CatchHandler @ 0010265a */
  std::__cxx11::string::string<std::allocator<char>>(local_270,"Jupiter",local_108);
  local_270 = local_1c8;
  local_100 = &local_289;
  local_38 = local_100;
                    /* try { // try from 00102386 to 00102391 has its CatchHandler @ 00102671 */
  std::__cxx11::string::string<std::allocator<char>>(local_270,"Saturn",local_100);
  local_270 = local_1a8;
  local_f8 = &local_28a;
  local_40 = local_f8;
                    /* try { // try from 001023bb to 001023c6 has its CatchHandler @ 00102688 */
  std::__cxx11::string::string<std::allocator<char>>(local_270,"Uranus",local_f8);
  local_270 = local_188;
  local_f0 = &local_28b;
  local_48 = local_f0;
                    /* try { // try from 001023f0 to 001023fb has its CatchHandler @ 0010269f */
  std::__cxx11::string::string<std::allocator<char>>(local_270,"Neptune",local_f0);
  local_28c = 0;
  local_168 = local_268;
  local_160 = 8;
  local_e8 = &local_28d;
                    /* try { // try from 00102445 to 00102450 has its CatchHandler @ 001026b3 */
  local_50 = local_e8;
  std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::vector
            (local_158,local_168,8);
  local_e0 = &local_28d;
  std::__new_allocator<std::__cxx11::string>::~__new_allocator(local_e0);
  local_2d0 = (string *)&local_168;
  do {
    local_2d0 = local_2d0 + -0x20;
    std::__cxx11::string::~string(local_2d0);
  } while (local_2d0 != local_268);
  local_d0 = (__new_allocator<char> *)&local_28b;
  std::__new_allocator<char>::~__new_allocator(local_d0);
  local_c0 = (__new_allocator<char> *)&local_28a;
  std::__new_allocator<char>::~__new_allocator(local_c0);
  local_b0 = (__new_allocator<char> *)&local_289;
  std::__new_allocator<char>::~__new_allocator(local_b0);
  local_a0 = (__new_allocator<char> *)&local_288;
  std::__new_allocator<char>::~__new_allocator(local_a0);
  local_90 = (__new_allocator<char> *)&local_287;
  std::__new_allocator<char>::~__new_allocator(local_90);
  local_80 = (__new_allocator<char> *)&local_286;
  std::__new_allocator<char>::~__new_allocator(local_80);
  local_70 = (__new_allocator<char> *)local_285;
  std::__new_allocator<char>::~__new_allocator(local_70);
  local_60 = (__new_allocator<char> *)&local_271;
  std::__new_allocator<char>::~__new_allocator(local_60);
  local_294 = -1;
  local_298 = -1;
  for (local_29c = 0; iVar1 = local_294,
      uVar3 = std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::size
                        (local_158), (ulong)(long)local_29c < uVar3; local_29c = local_29c + 1) {
    psVar4 = (string *)
             std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[]
                       (local_158,(long)local_29c);
  ...
  if ((local_294 == -1) || (local_298 == -1)) {
    ...
    memset(param_1,0,0x18);
    std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::vector(param_1);
    while (local_29c = local_294 + 1, local_29c < local_298) {
      psVar4 = (string *)
               std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[]
                         (local_158,(long)local_29c);
                    /* try { // try from 0010295e to 00102962 has its CatchHandler @ 00102978 */
      std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::push_back
                (param_1,psVar4);
      local_294 = local_29c;
    }
  }
  std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::~vector(local_158);
  return param_1;
}
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 00102a48 to 00102a9f has its CatchHandler @ 00102a56 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 00102a48 with catch @ 00102a56 */
...

{
  ...
  uVar3 = initializer_list<std::__cxx11::string>::size
                    ((initializer_list<std::__cxx11::string> *)&local_18);
                    /* try { // try from 00102b1f to 00102b23 has its CatchHandler @ 00102b2c */
...
{
                    /* try { // try from 00102b64 to 00102b68 has its CatchHandler @ 00102b7a */
  _M_dispose(this);
  _Alloc_hider::~_Alloc_hider((_Alloc_hider *)this);
  return;
}
...

{
  ...
  if (lVar2 == lVar3) {
    ...
    uVar6 = __cxx11::string::size(param_1);
                    /* try { // try from 00102c25 to 00102c29 has its CatchHandler @ 00102c48 */
...

{
  ...
  _Vector_base<std::__cxx11::string,std::allocator<std::__cxx11::string>>::_M_get_Tp_allocator
            ((_Vector_base<std::__cxx11::string,std::allocator<std::__cxx11::string>> *)this);
                    /* try { // try from 00102dc4 to 00102dc8 has its CatchHandler @ 00102ddc */
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 00102f68 to 00102f6c has its CatchHandler @ 00102fae */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00103182 to 0010319d has its CatchHandler @ 001031b2 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 001033c1 to 001033c5 has its CatchHandler @ 001033d0 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 001033fe to 0010343b has its CatchHandler @ 00103453 */
...
/* WARNING: Removing unreachable block (ram,0x00103526) */
...
{
                    /* try { // try from 001037c2 to 001037c6 has its CatchHandler @ 001037d8 */
...

{
  ...
  for (; local_10 != local_18; local_10 = local_10 + 0x20) {
                    /* try { // try from 00103a63 to 00103aa5 has its CatchHandler @ 00103a86 */
...
{
  if (*(long *)(this + 8) != 0) {
                    /* try { // try from 00103b79 to 00103b7d has its CatchHandler @ 00103b88 */
...

{
  ...
  local_18 = local_48;
  local_10 = local_40;
                    /* try { // try from 00103c09 to 00103c0d has its CatchHandler @ 00103c5b */
  ...
  uVar2 = length(local_68);
                    /* try { // try from 00103c4b to 00103c4f has its CatchHandler @ 00103c7a */
...
/* WARNING: Removing unreachable block (ram,0x00103d44) */
...

{
  ...
  local_38 = this;
  local_20 = local_58;
                    /* try { // try from 001040b8 to 001040bc has its CatchHandler @ 0010419b */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 001043b9 to 001043bd has its CatchHandler @ 001043c8 */
...

{
  ...
  paVar3 = (allocator *)_M_get_allocator(param_1);
                    /* try { // try from 001045b5 to 00104676 has its CatchHandler @ 0010467f */
