...

{
  ...
  for (local_38 = 0; uVar4 = (ulong)local_38,
      uVar5 = std::vector<int,std::allocator<int>>::size(param_2), uVar4 < uVar5;
      local_38 = local_38 + 1) {
    local_3c = 0;
    piVar6 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_38);
    local_40 = *piVar6;
    if (local_40 < 1) {
      local_40 = -local_40;
    }
    for (; 0 < local_40; local_40 = local_40 / 2) {
      local_3c = local_40 % 2 + local_3c;
    }
                    /* try { // try from 00101286 to 00101292 has its CatchHandler @ 001012a2 */
    std::vector<int,std::allocator<int>>::push_back(local_30,&local_3c);
  }
  local_50 = 0;
  do {
    uVar4 = std::vector<int,std::allocator<int>>::size(param_2);
    if (uVar4 <= (ulong)(long)local_50) {
      std::vector<int,std::allocator<int>>::vector(param_1,param_2);
      std::vector<int,std::allocator<int>>::~vector(local_30);
      return param_1;
    }
    for (local_54 = 1; uVar4 = std::vector<int,std::allocator<int>>::size(param_2),
        (ulong)(long)local_54 < uVar4; local_54 = local_54 + 1) {
      piVar6 = (int *)std::vector<int,std::allocator<int>>::operator[](local_30,(long)local_54);
      iVar1 = *piVar6;
      piVar6 = (int *)std::vector<int,std::allocator<int>>::operator[]
                                (local_30,(long)(local_54 + -1));
      if (iVar1 < *piVar6) {
LAB_001013b0:
        puVar7 = (undefined4 *)
                 std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_54);
        local_34 = *puVar7;
        puVar7 = (undefined4 *)
                 std::vector<int,std::allocator<int>>::operator[](param_2,(long)(local_54 + -1));
        uVar2 = *puVar7;
        puVar7 = (undefined4 *)
                 std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_54);
        uVar3 = local_34;
        ...
        *puVar7 = uVar3;
        puVar7 = (undefined4 *)
                 std::vector<int,std::allocator<int>>::operator[](local_30,(long)local_54);
        local_34 = *puVar7;
        puVar7 = (undefined4 *)
                 std::vector<int,std::allocator<int>>::operator[](local_30,(long)(local_54 + -1));
        uVar2 = *puVar7;
        puVar7 = (undefined4 *)
                 std::vector<int,std::allocator<int>>::operator[](local_30,(long)local_54);
        uVar3 = local_34;
        ...
        *puVar7 = uVar3;
        ...
        piVar6 = (int *)std::vector<int,std::allocator<int>>::operator[]
                                  (local_30,(long)(local_54 + -1));
        if (iVar1 == *piVar6) {
          piVar6 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_54);
          iVar1 = *piVar6;
          piVar6 = (int *)std::vector<int,std::allocator<int>>::operator[]
                                    (param_2,(long)(local_54 + -1));
          if (iVar1 < *piVar6) goto LAB_001013b0;
        }
      }
    }
    local_50 = local_50 + 1;
...
{
                    /* try { // try from 00101852 to 00101856 has its CatchHandler @ 00101868 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00101db9 to 00101dbd has its CatchHandler @ 00101dc8 */
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 00101e76 to 00101e82 has its CatchHandler @ 00101e96 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
