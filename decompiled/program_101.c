...
/* words_string(std::__cxx11::string) */

vector<std::__cxx11::string,std::allocator<std::__cxx11::string>> *
words_string(vector<std::__cxx11::string,std::allocator<std::__cxx11::string>> *param_1,
            string *param_2)

{
  ...
  local_28 = &local_59;
                    /* try { // try from 0010223b to 0010224a has its CatchHandler @ 00102377 */
  local_38 = param_2;
  local_30 = param_1;
  local_10 = local_28;
  ...
  *(undefined8 *)(param_1 + 0x10) = 0;
  std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::vector(param_1);
                    /* try { // try from 00102283 to 001023f6 has its CatchHandler @ 00102399 */
  std::operator+(local_90,(char)param_2);
  std::__cxx11::string::operator=(param_2,local_90);
  std::__cxx11::string::~string(local_90);
  for (local_94 = 0; uVar1 = (ulong)local_94, uVar2 = std::__cxx11::string::length(param_2),
      uVar1 < uVar2; local_94 = local_94 + 1) {
    pcVar3 = (char *)std::__cxx11::string::operator[](param_2,(long)local_94);
    if ((*pcVar3 == ' ') ||
       (pcVar3 = (char *)std::__cxx11::string::operator[](param_2,(long)local_94), *pcVar3 == ','))
    {
      lVar4 = std::__cxx11::string::length(local_58);
      if (lVar4 != 0) {
      ...
      std::__cxx11::string::operator[](param_2,(long)local_94);
      std::operator+(local_b8,(char)local_58);
      std::__cxx11::string::operator=(local_58,local_b8);
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 001024b8 to 0010250f has its CatchHandler @ 001024c6 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 001024b8 with catch @ 001024c6 */
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 001025ab to 001025b9 has its CatchHandler @ 001025d7 */
...
/* WARNING: Removing unreachable block (ram,0x00102638) */
...

{
  ...
  char *local_40;
                    ...
                    /* try { // try from 0010261f to 00102724 has its CatchHandler @ 001027ea */
  _M_is_local(this);
...
{
                    /* try { // try from 00102814 to 00102818 has its CatchHandler @ 0010282a */
  _M_dispose(this);
  _Alloc_hider::~_Alloc_hider((_Alloc_hider *)this);
  return;
}
...

{
  ...
  _Vector_base<std::__cxx11::string,std::allocator<std::__cxx11::string>>::_M_get_Tp_allocator
            ((_Vector_base<std::__cxx11::string,std::allocator<std::__cxx11::string>> *)this);
                    /* try { // try from 001029e4 to 001029e8 has its CatchHandler @ 001029fc */
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 00102b88 to 00102b8c has its CatchHandler @ 00102bce */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00102da2 to 00102dbd has its CatchHandler @ 00102dd2 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00102fe1 to 00102fe5 has its CatchHandler @ 00102ff0 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 0010301e to 0010305b has its CatchHandler @ 00103073 */
...
{
                    /* try { // try from 00103282 to 00103286 has its CatchHandler @ 00103298 */
...
/* WARNING: Removing unreachable block (ram,0x001034af) */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 00103472 to 001034a2 has its CatchHandler @ 001034b1 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 001035d8 to 001035ef has its CatchHandler @ 001035f8 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 00103704 to 00103708 has its CatchHandler @ 00103764 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...
{
                    /* try { // try from 001039c0 to 001039c8 has its CatchHandler @ 001039d1 */
  _M_set_length(this,0);
  return;
}
...

{
  ...
  local_38 = this;
  local_20 = local_58;
                    /* try { // try from 00103b28 to 00103b2c has its CatchHandler @ 00103c0b */
...

{
  ...
  local_18 = local_48;
  local_10 = local_40;
                    /* try { // try from 00103cb9 to 00103cbd has its CatchHandler @ 00103d0b */
  ...
  uVar2 = length(local_68);
                    /* try { // try from 00103cfb to 00103cff has its CatchHandler @ 00103d2a */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00104079 to 0010407d has its CatchHandler @ 00104088 */
...

{
  ...
  paVar3 = (allocator *)_M_get_allocator(param_1);
                    /* try { // try from 00104365 to 00104426 has its CatchHandler @ 0010442f */
