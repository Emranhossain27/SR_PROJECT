...
/* sum_squares(std::vector<int, std::allocator<int> >) */

int sum_squares(vector<int,std::allocator<int>> *param_1)

{
  ...
  local_14 = 0;
  for (local_18 = 0; uVar3 = std::vector<int,std::allocator<int>>::size(param_1),
      (ulong)(long)local_18 < uVar3; local_18 = local_18 + 1) {
    if (local_18 % 3 == 0) {
