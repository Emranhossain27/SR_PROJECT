...
/* check_if_last_char_is_a_letter(std::__cxx11::string) */

undefined8 check_if_last_char_is_a_letter(string *param_1)

{
  ...
  if (lVar2 == 0) {
    ...
    lVar2 = std::__cxx11::string::length(param_1);
    pcVar3 = (char *)std::__cxx11::string::operator[](param_1,lVar2 - 1);
    cVar1 = *pcVar3;
    uVar4 = (ulong)(uint)(int)cVar1;
    if ((cVar1 < 0x41) ||
       ((('Z' < cVar1 && (uVar4 = (ulong)(uint)(int)cVar1, cVar1 < 0x61)) ||
        (uVar4 = (ulong)(uint)(int)cVar1, 0x7a < cVar1)))) {
      local_9 = 0;
    }
    else {
      lVar2 = std::__cxx11::string::length(param_1);
      if (lVar2 == 1) {
        ...
        lVar2 = std::__cxx11::string::length(param_1);
        pcVar3 = (char *)std::__cxx11::string::operator[](param_1,lVar2 - 2);
        cVar1 = *pcVar3;
        if (((cVar1 < 'A') || (uVar4 = (ulong)(uint)(int)cVar1, 0x5a < cVar1)) &&
           ((uVar4 = (ulong)(uint)(int)cVar1, cVar1 < 0x61 ||
            (uVar4 = (ulong)(uint)(int)cVar1, 0x7a < cVar1)))) {
          local_9 = 1;
        }
        else {
