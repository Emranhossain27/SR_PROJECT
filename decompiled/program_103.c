...
/* rounded_avg[abi:cxx11](int, int) */

string * rounded_avg_abi_cxx11_(int param_1,int param_2)

{
  ...
  if (in_EDX < param_2) {
    local_48 = local_59;
    local_10 = local_48;
                    /* try { // try from 00102225 to 00102230 has its CatchHandler @ 00102249 */
    std::__cxx11::string::string<std::allocator<char>>(this,"-1",local_48);
    local_38 = (__new_allocator<char> *)local_59;
    std::__new_allocator<char>::~__new_allocator(local_38);
  }
  else {
    local_70 = (in_EDX + param_2) / 2;
    local_71 = 0;
    local_40 = &local_72;
    local_18 = local_40;
                    /* try { // try from 0010229a to 001022a5 has its CatchHandler @ 00102341 */
    std::__cxx11::string::string<std::allocator<char>>(this,"",local_40);
    local_28 = (__new_allocator<char> *)&local_72;
    std::__new_allocator<char>::~__new_allocator(local_28);
    for (; 0 < local_70; local_70 = local_70 / 2) {
      std::__cxx11::to_string(local_b8,local_70 % 2);
                    /* try { // try from 001022f5 to 00102300 has its CatchHandler @ 00102360 */
      std::operator+(local_98,(string *)local_b8);
      std::__cxx11::string::operator=(this,local_98);
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 00102408 to 0010245f has its CatchHandler @ 00102416 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 00102408 with catch @ 00102416 */
...

{
  ...
  local_30 = this;
                    /* try { // try from 0010289b to 001028e6 has its CatchHandler @ 001028ef */
  pcVar1 = (char *)_M_local_data(this);
  local_28 = &local_31;
  local_10 = local_28;
...
{
                    /* try { // try from 00102bf7 to 00102bfb has its CatchHandler @ 00102c04 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 00102c24 to 00102c28 has its CatchHandler @ 00102c84 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...

{
  ...
  local_28 = this;
                    /* try { // try from 00102ebe to 00102efb has its CatchHandler @ 00102f13 */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 001033d2 to 001033ed has its CatchHandler @ 00103402 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 001034a1 to 001034a5 has its CatchHandler @ 001034b0 */
...

{
  ...
  paVar3 = (allocator *)_M_get_allocator(param_1);
                    /* try { // try from 00103545 to 00103606 has its CatchHandler @ 0010360f */
...
{
                    /* try { // try from 001038c0 to 001038c8 has its CatchHandler @ 001038d1 */
  _M_set_length(this,0);
  return;
}
