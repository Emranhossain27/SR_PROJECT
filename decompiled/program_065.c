...
/* vowels_count(std::__cxx11::string) */

int vowels_count(string *param_1)

{
  ...
  local_50 = param_1;
  local_10 = local_48;
  std::__cxx11::string::string<std::allocator<char>>(local_70,"aeiouAEIOU",local_48);
  ...
  while( true ) {
    ...
    local_a8 = std::__cxx11::string::end(local_70);
                    /* try { // try from 001022bf to 001023f4 has its CatchHandler @ 00102371 */
  ...
  lVar5 = std::__cxx11::string::length(param_1);
  pcVar6 = (char *)std::__cxx11::string::operator[](param_1,lVar5 - 1);
  if (*pcVar6 != 'y') {
    lVar5 = std::__cxx11::string::length(param_1);
    pcVar6 = (char *)std::__cxx11::string::operator[](param_1,lVar5 - 1);
    if (*pcVar6 != 'Y') goto LAB_00102416;
  }
  local_88 = local_88 + 1;
LAB_00102416:
  iVar1 = local_88;
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 00102488 to 001024df has its CatchHandler @ 00102496 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 00102488 with catch @ 00102496 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00102d31 to 00102d35 has its CatchHandler @ 00102d40 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 00102d6e to 00102dab has its CatchHandler @ 00102dc3 */
...
/* WARNING: Removing unreachable block (ram,0x00102e96) */
