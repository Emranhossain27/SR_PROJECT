...
/* get_positive(std::vector<float, std::allocator<float> >) */

vector<float,std::allocator<float>> *
get_positive(vector<float,std::allocator<float>> *param_1,
...

{
  ...
  for (local_20 = 0; uVar1 = std::vector<float,std::allocator<float>>::size(param_2),
      (ulong)(long)local_20 < uVar1; local_20 = local_20 + 1) {
    pfVar2 = (float *)std::vector<float,std::allocator<float>>::operator[](param_2,(long)local_20);
    if (0.0 < *pfVar2) {
      pfVar2 = (float *)std::vector<float,std::allocator<float>>::operator[](param_2,(long)local_20)
      ;
                    /* try { // try from 00101269 to 0010126d has its CatchHandler @ 00101272 */
...
{
                    /* try { // try from 00101552 to 00101556 has its CatchHandler @ 00101568 */
