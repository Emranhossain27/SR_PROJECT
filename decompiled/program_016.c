...

{
  ...
  sVar1 = (*(code *)PTR_strlen_00108018)();
  return sVar1;
}
...
{
  (*(code *)PTR___throw_logic_error_00108028)();
  return;
}
...
{
  (*(code *)PTR___throw_bad_array_new_length_00108030)();
  return;
}
...

{
  ...
  pvVar1 = (void *)(*(code *)PTR_memcpy_00108038)();
  return pvVar1;
}
...

{
  ...
  pvVar1 = (void *)(*(code *)PTR_operator_new_00108040)();
  return pvVar1;
}
...
{
  (*(code *)PTR_operator_delete_00108048)();
  return;
}
...
{
  (*(code *)PTR___throw_out_of_range_fmt_00108050)();
  return;
}
...

{
  ...
  pvVar1 = (void *)(*(code *)PTR_memmove_00108058)();
  return pvVar1;
}
...
/* string_sequence[abi:cxx11](int) */

string * string_sequence_abi_cxx11_(int param_1)

{
  ...
  local_30 = this;
  local_10 = local_28;
                    /* try { // try from 00102237 to 00102242 has its CatchHandler @ 001022ea */
  std::__cxx11::string::string<std::allocator<char>>(this,"0",local_28);
  local_20 = (__new_allocator<char> *)&local_36;
  std::__new_allocator<char>::~__new_allocator(local_20);
  for (local_48 = 1; local_48 <= local_34; local_48 = local_48 + 1) {
                    /* try { // try from 00102269 to 0010227f has its CatchHandler @ 00102309 */
    std::operator+(local_88,(char *)this);
    std::__cxx11::to_string(local_a8,local_48);
                    /* try { // try from 0010229f to 001022ab has its CatchHandler @ 00102317 */
    std::operator+(local_68,local_88);
    std::__cxx11::string::operator=(this,local_68);
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 001023c8 to 0010241f has its CatchHandler @ 001023d6 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 001023c8 with catch @ 001023d6 */
...

{
  ...
  local_30 = in_RDX;
  local_28 = (string *)param_2;
  local_20 = param_1;
  uVar1 = __cxx11::string::c_str((string *)param_2);
  uVar2 = __cxx11::string::size(local_28);
  uVar3 = char_traits<char>::length(local_30);
  __cxx11::string::get_allocator();
                    /* try { // try from 00102586 to 0010258a has its CatchHandler @ 001025ab */
  __str_concat<std::__cxx11::string>(param_1,uVar1,uVar2,local_30,uVar3,&local_31);
  local_18 = &local_31;
...

{
  ...
  local_30 = CONCAT31(local_30._1_3_,bVar2);
                    /* try { // try from 0010267d to 00102681 has its CatchHandler @ 001026a1 */
...

{
  ...
  local_30 = this;
                    /* try { // try from 001029ab to 001029f6 has its CatchHandler @ 001029ff */
  pcVar1 = (char *)_M_local_data(this);
  local_28 = &local_31;
  local_10 = local_28;
...
{
                    /* try { // try from 00102d07 to 00102d0b has its CatchHandler @ 00102d14 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 00102d34 to 00102d38 has its CatchHandler @ 00102d94 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...

{
  ...
  local_28 = this;
                    /* try { // try from 00102fce to 0010300b has its CatchHandler @ 00103023 */
...
/* WARNING: Removing unreachable block (ram,0x00103136) */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 001034e2 to 001034fd has its CatchHandler @ 00103512 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 001035b1 to 001035b5 has its CatchHandler @ 001035c0 */
...
/* WARNING: Removing unreachable block (ram,0x001036af) */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 00103672 to 001036a2 has its CatchHandler @ 001036b1 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 00103798 to 001037af has its CatchHandler @ 001037b8 */
...

{
  ...
  paVar3 = (allocator *)_M_get_allocator(param_1);
                    /* try { // try from 00103ae5 to 00103ba6 has its CatchHandler @ 00103baf */
...
{
                    /* try { // try from 00104150 to 00104158 has its CatchHandler @ 00104161 */
  _M_set_length(this,0);
  return;
}
