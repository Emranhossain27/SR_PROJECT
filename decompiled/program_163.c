...
/* WARNING: Removing unreachable block (ram,0x00101287) */
/* generate_integers(int, int) */

vector<int,std::allocator<int>> * generate_integers(int param_1,int param_2)

{
  ...
  for (local_24 = local_14; local_24 <= local_18; local_24 = local_24 + 1) {
    if ((local_24 < 10) && (local_24 % 2 == 0)) {
                    /* try { // try from 00101248 to 00101254 has its CatchHandler @ 00101259 */
      std::vector<int,std::allocator<int>>::push_back(this,&local_24);
    }
  }
  return this;
}
