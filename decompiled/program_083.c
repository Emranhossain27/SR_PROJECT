...
/* prime_length(std::__cxx11::string) */

undefined1 prime_length(string *param_1)

{
  ...
  iVar1 = std::__cxx11::string::length(param_1);
  if (iVar1 < 2) {
    local_9 = 0;
  }
  else {
    for (local_20 = 2; local_20 * local_20 <= iVar1; local_20 = local_20 + 1) {
      if (iVar1 % local_20 == 0) {
        return 0;
      }
    }
...

{
  ...
  local_28 = this;
                    /* try { // try from 0010124e to 0010128b has its CatchHandler @ 001012a3 */
