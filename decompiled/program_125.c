...

{
  ...
  pvVar1 = (void *)(*(code *)PTR_memchr_00109058)();
  return pvVar1;
}
...

{
  ...
  pvVar1 = (void *)(*(code *)PTR_memmove_00109060)();
  return pvVar1;
}
...
/* split_words(std::__cxx11::string) */

vector<std::__cxx11::string,std::allocator<std::__cxx11::string>> *
split_words(vector<std::__cxx11::string,std::allocator<std::__cxx11::string>> *param_1,
           string *param_2)

{
  ...
  long lVar4;
  string *local_298;
  __new_allocator<std::__cxx11::string> local_209;
  ...
  long *local_60;
  long *local_58;
  __new_allocator<std::__cxx11::string> *local_50;
  __new_allocator<std::__cxx11::string> *local_48;
  __new_allocator<std::__cxx11::string> *local_38;
  long *local_30;
  long *local_28;
  long *local_20;
  long *local_18;
  ...
  local_88 = &local_c1;
                    /* try { // try from 00102254 to 00102266 has its CatchHandler @ 00102411 */
  local_98 = param_2;
  local_90 = param_1;
  local_10 = local_88;
  std::__cxx11::string::string<std::allocator<char>>(local_c0,"",local_88);
  ...
  local_108 = std::__cxx11::string::begin(param_2);
  local_110 = std::__cxx11::string::end(param_2);
  local_111 = 0x20;
                    /* try { // try from 001022d9 to 001027bd has its CatchHandler @ 0010243c */
  local_100 = std::find<__gnu_cxx::__normal_iterator<char*,std::__cxx11::string>,char>
                        (local_108,local_110,&local_111);
  local_120 = std::__cxx11::string::end(param_2);
  local_58 = &local_100;
  local_60 = &local_120;
  local_30 = local_60;
  local_28 = local_58;
  if (local_100 == local_120) {
    local_178 = std::__cxx11::string::begin(param_2);
    local_180 = std::__cxx11::string::end(param_2);
    local_181 = 0x2c;
    local_170 = std::find<__gnu_cxx::__normal_iterator<char*,std::__cxx11::string>,char>
                          (local_178,local_180,&local_181);
    local_190 = std::__cxx11::string::end(param_2);
    local_68 = &local_170;
    local_70 = &local_190;
    local_20 = local_70;
    local_18 = local_68;
    if (local_170 == local_190) {
      local_1d4 = 0;
      for (local_9c = 0; uVar1 = (ulong)local_9c, uVar2 = std::__cxx11::string::length(param_2),
          uVar1 < uVar2; local_9c = local_9c + 1) {
        pcVar3 = (char *)std::__cxx11::string::operator[](param_2,(long)local_9c);
        if ((('`' < *pcVar3) &&
            (pcVar3 = (char *)std::__cxx11::string::operator[](param_2,(long)local_9c),
            *pcVar3 < '{')) &&
           (pcVar3 = (char *)std::__cxx11::string::operator[](param_2,(long)local_9c),
      ...
      std::__cxx11::to_string(local_208,local_1d4);
      local_1e0 = 1;
      local_50 = &local_209;
      local_1e8 = local_208;
      local_38 = local_50;
                    /* try { // try from 0010285d to 00102861 has its CatchHandler @ 001028ce */
      std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::vector
                (param_1,local_208,1);
      local_48 = &local_209;
      std::__new_allocator<std::__cxx11::string>::~__new_allocator(local_48);
      local_298 = (string *)&local_1e8;
      do {
        local_298 = local_298 + -0x20;
        std::__cxx11::string::~string(local_298);
      } while (local_298 != (string *)local_208);
    }
    else {
      std::operator+(local_1b0,(char)param_2);
      ...
      for (local_9c = 0; uVar1 = (ulong)local_9c, uVar2 = std::__cxx11::string::length(param_2),
        ...
        pcVar3 = (char *)std::__cxx11::string::operator[](param_2,(long)local_9c);
        if (*pcVar3 == ',') {
          lVar4 = std::__cxx11::string::length(local_c0);
          if (lVar4 != 0) {
          ...
          std::__cxx11::string::operator[](param_2,(long)local_9c);
          std::operator+(local_1d0,(char)local_c0);
          std::__cxx11::string::operator=(local_c0,local_1d0);
          std::__cxx11::string::~string(local_1d0);
        }
      }
      std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::vector
                (param_1,(vector *)&local_f8);
    }
  }
  else {
    std::operator+(local_140,(char)param_2);
    std::__cxx11::string::operator=(param_2,local_140);
    ...
    for (local_9c = 0; uVar1 = (ulong)local_9c, uVar2 = std::__cxx11::string::length(param_2),
      ...
      if (*pcVar3 == ' ') {
        ...
        std::__cxx11::string::operator[](param_2,(long)local_9c);
        std::operator+(local_160,(char)local_c0);
        std::__cxx11::string::operator=(local_c0,local_160);
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 001029d8 to 00102a2f has its CatchHandler @ 001029e6 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 001029d8 with catch @ 001029e6 */
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 00102ccb to 00102cd9 has its CatchHandler @ 00102cf7 */
...
/* WARNING: Removing unreachable block (ram,0x00102d58) */
...

{
  ...
  char *local_40;
                    ...
                    /* try { // try from 00102d3f to 00102e44 has its CatchHandler @ 00102f0a */
  _M_is_local(this);
...
{
                    /* try { // try from 00102f34 to 00102f38 has its CatchHandler @ 00102f4a */
  _M_dispose(this);
  _Alloc_hider::~_Alloc_hider((_Alloc_hider *)this);
  return;
}
...
/* WARNING: Removing unreachable block (ram,0x0010319e) */
...

{
  ...
  local_30 = CONCAT31(local_30._1_3_,bVar2);
                    /* try { // try from 0010318d to 00103191 has its CatchHandler @ 001031b1 */
...

{
  ...
  uVar3 = initializer_list<std::__cxx11::string>::size
                    ((initializer_list<std::__cxx11::string> *)&local_18);
                    /* try { // try from 0010321f to 00103223 has its CatchHandler @ 0010322c */
...

{
  ...
  _Vector_base<std::__cxx11::string,std::allocator<std::__cxx11::string>>::_M_get_Tp_allocator
            ((_Vector_base<std::__cxx11::string,std::allocator<std::__cxx11::string>> *)this);
                    /* try { // try from 00103294 to 00103298 has its CatchHandler @ 001032ac */
...

{
  ...
  local_30 = this;
                    /* try { // try from 001034cb to 00103516 has its CatchHandler @ 0010351f */
  pcVar1 = (char *)_M_local_data(this);
  local_28 = &local_31;
  local_10 = local_28;
...
{
                    /* try { // try from 00103827 to 0010382b has its CatchHandler @ 00103834 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 00103854 to 00103858 has its CatchHandler @ 001038b4 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...

{
  ...
  local_28 = this;
                    /* try { // try from 00103ace to 00103b0b has its CatchHandler @ 00103b23 */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00103fa2 to 00103fbd has its CatchHandler @ 00103fd2 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00104071 to 00104075 has its CatchHandler @ 00104080 */
...
{
                    /* try { // try from 001040d2 to 001040d6 has its CatchHandler @ 001040e8 */
...
/* WARNING: Removing unreachable block (ram,0x0010432f) */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 001042f2 to 00104322 has its CatchHandler @ 00104331 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 00104418 to 0010442f has its CatchHandler @ 00104438 */
...
{
                    /* try { // try from 001046e0 to 001046e8 has its CatchHandler @ 001046f1 */
  _M_set_length(this,0);
  return;
}
...

{
  ...
  local_38 = this;
  local_20 = local_58;
                    /* try { // try from 00104848 to 0010484c has its CatchHandler @ 0010492b */
...

{
  ...
  local_18 = local_48;
  local_10 = local_40;
                    /* try { // try from 001049d9 to 001049dd has its CatchHandler @ 00104a2b */
  ...
  uVar2 = length(local_68);
                    /* try { // try from 00104a1b to 00104a1f has its CatchHandler @ 00104a4a */
...
/* WARNING: Removing unreachable block (ram,0x00104ad4) */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00104d59 to 00104d5d has its CatchHandler @ 00104d68 */
...

{
  ...
  paVar3 = (allocator *)_M_get_allocator(param_1);
                    /* try { // try from 00105045 to 00105106 has its CatchHandler @ 0010510f */
...

{
  ...
  for (; local_10 != local_18; local_10 = local_10 + 0x20) {
                    /* try { // try from 001057f3 to 00105835 has its CatchHandler @ 00105816 */
...
{
  if (*(long *)(this + 8) != 0) {
                    /* try { // try from 00105909 to 0010590d has its CatchHandler @ 00105918 */
