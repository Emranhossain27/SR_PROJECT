...
/* max_fill(std::vector<std::vector<int, std::allocator<int> >, std::allocator<std::vector<int,
   std::allocator<int> > > >, int) */

int max_fill(vector<std::vector<int,std::allocator<int>>,std::allocator<std::vector<int,std::allocator<int>>>>
             *param_1,int param_2)
  ...
  while( true ) {
    ...
    while( true ) {
      pvVar2 = (vector<int,std::allocator<int>> *)
               std::
               vector<std::vector<int,std::allocator<int>>,std::allocator<std::vector<int,std::allocator<int>>>>
               ::operator[](param_1,(long)local_1c);
      uVar1 = std::vector<int,std::allocator<int>>::size(pvVar2);
      if (uVar1 <= (ulong)(long)local_24) break;
      pvVar2 = (vector<int,std::allocator<int>> *)
               std::
               vector<std::vector<int,std::allocator<int>>,std::allocator<std::vector<int,std::allocator<int>>>>
               ::operator[](param_1,(long)local_1c);
      piVar3 = (int *)std::vector<int,std::allocator<int>>::operator[](pvVar2,(long)local_24);
      local_20 = *piVar3 + local_20;
      local_24 = local_24 + 1;
    }
    if (0 < local_20) {
      local_18 = (local_20 + -1) / param_2 + 1 + local_18;
    }
    local_1c = local_1c + 1;
  }
  return local_18;
