...
/* below_zero(std::vector<int, std::allocator<int> >) */

undefined8 below_zero(vector<int,std::allocator<int>> *param_1)
...
LAB_001011ad:
    ...
    piVar3 = (int *)std::vector<int,std::allocator<int>>::operator[](param_1,(long)local_20);
    local_1c = *piVar3 + local_1c;
