...
/* WARNING: Removing unreachable block (ram,0x001022ef) */
/* concatenate(std::vector<std::__cxx11::string, std::allocator<std::__cxx11::string > >) */

string * concatenate(string *param_1,
...

{
  ...
  local_30 = param_1;
  local_10 = local_28;
                    /* try { // try from 00102226 to 00102231 has its CatchHandler @ 001022af */
  ...
  for (local_50 = 0; uVar1 = (ulong)local_50,
    ...
    std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[]
              (param_2,(long)local_50);
                    /* try { // try from 00102283 to 0010228b has its CatchHandler @ 001022ce */
    std::operator+(local_70,param_1);
    std::__cxx11::string::operator=(param_1,local_70);
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 00102358 to 001023af has its CatchHandler @ 00102366 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 00102358 with catch @ 00102366 */
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 0010247f to 00102483 has its CatchHandler @ 001024a4 */
...

{
  ...
  char *local_40;
                    ...
                    /* try { // try from 0010256f to 00102674 has its CatchHandler @ 0010273a */
  _M_is_local(this);
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 00102888 to 0010288c has its CatchHandler @ 001028ce */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00102aa2 to 00102abd has its CatchHandler @ 00102ad2 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00102ce1 to 00102ce5 has its CatchHandler @ 00102cf0 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 00102d1e to 00102d5b has its CatchHandler @ 00102d73 */
...
/* WARNING: Removing unreachable block (ram,0x0010302f) */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 00102ff2 to 00103022 has its CatchHandler @ 00103031 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 00103158 to 0010316f has its CatchHandler @ 00103178 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 00103284 to 00103288 has its CatchHandler @ 001032e4 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
