...
/* smallest_change(std::vector<int, std::allocator<int> >) */

int smallest_change(vector<int,std::allocator<int>> *param_1)

{
  ...
  local_18 = 0;
  while( true ) {
    lVar2 = std::vector<int,std::allocator<int>>::size(param_1);
    if ((ulong)((lVar2 + -1) - (long)local_18) <= (ulong)(long)local_18) break;
