...
/* sum_product(std::vector<int, std::allocator<int> >) */

undefined8 sum_product(undefined8 param_1,vector<int,std::allocator<int>> *param_2)

{
  ...
  while( true ) {
    ...
    local_3c = *piVar3 + local_3c;
    piVar3 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_44);
    local_40 = *piVar3 * local_40;
    local_44 = local_44 + 1;
  }
  local_60 = local_3c;
  local_5c = local_40;
  ...
  local_28 = &local_61;
  local_10 = local_28;
                    /* try { // try from 001012a4 to 001012a8 has its CatchHandler @ 001012c9 */
...

{
  ...
  uVar3 = initializer_list<int>::size((initializer_list<int> *)&local_18);
                    /* try { // try from 0010140f to 00101413 has its CatchHandler @ 0010141c */
...
{
                    /* try { // try from 001015d2 to 001015d6 has its CatchHandler @ 001015e8 */
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 00101816 to 00101822 has its CatchHandler @ 00101836 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
