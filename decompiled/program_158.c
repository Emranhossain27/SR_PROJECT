...

{
  ...
  pvVar1 = (void *)(*(code *)PTR_memchr_00106060)();
  return pvVar1;
}
...
/* WARNING: Removing unreachable block (ram,0x001025ad) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* find_max(std::vector<std::__cxx11::string, std::allocator<std::__cxx11::string > >) */

string * find_max(string *param_1,
...

{
  ...
  local_70 = param_1;
  local_10 = local_68;
                    /* try { // try from 0010224f to 0010225a has its CatchHandler @ 00102472 */
  std::__cxx11::string::string<std::allocator<char>>(param_1,"",local_68);
  local_58 = (__new_allocator<char> *)&local_7a;
  std::__new_allocator<char>::~__new_allocator(local_58);
  local_90 = 0;
  local_94 = 0;
  do {
    uVar2 = (ulong)local_94;
    uVar3 = std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::size(param_2);
    if (uVar3 <= uVar2) {
      return param_1;
    }
    local_60 = &local_b9;
                    /* try { // try from 001022c2 to 001022d4 has its CatchHandler @ 00102497 */
    local_18 = local_60;
    std::__cxx11::string::string<std::allocator<char>>(local_b8,"",local_60);
    local_48 = (__new_allocator<char> *)&local_b9;
    ...
    while( true ) {
      ...
      uVar3 = std::__cxx11::string::length(psVar4);
      if (uVar3 <= uVar2) break;
      local_d0 = std::__cxx11::string::begin(local_b8);
      local_d8 = std::__cxx11::string::end(local_b8);
      psVar4 = (string *)
               std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[]
                         (param_2,(long)local_94);
                    /* try { // try from 0010237b to 0010256e has its CatchHandler @ 001024bf */
      uVar5 = std::__cxx11::string::operator[](psVar4,(long)local_c0);
      local_c8 = std::find<__gnu_cxx::__normal_iterator<char*,std::__cxx11::string>,char>
                           (local_d0,local_d8,uVar5);
      local_e0 = std::__cxx11::string::end(local_b8);
      local_30 = &local_c8;
      local_38 = &local_e0;
      local_28 = local_38;
      local_20 = local_30;
      if (local_c8 == local_e0) {
        psVar4 = (string *)
                 std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[]
                           (param_2,(long)local_94);
        std::__cxx11::string::operator[](psVar4,(long)local_c0);
        std::operator+(local_100,(char)local_b8);
        std::__cxx11::string::operator=(local_b8,local_100);
        std::__cxx11::string::~string(local_100);
      }
      local_c0 = local_c0 + 1;
    }
    uVar2 = std::__cxx11::string::length(local_b8);
    if ((ulong)(long)local_90 < uVar2) {
LAB_0010254d:
      psVar4 = (string *)
               std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[]
                         (param_2,(long)local_94);
      std::__cxx11::string::operator=(param_1,psVar4);
      local_90 = std::__cxx11::string::length(local_b8);
    }
    else {
      lVar6 = std::__cxx11::string::length(local_b8);
      if (lVar6 == local_90) {
        psVar4 = (string *)
                 std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::operator[]
                           (param_2,(long)local_94);
        bVar1 = std::operator<(psVar4,param_1);
        if (bVar1) goto LAB_0010254d;
      }
    }
...

{
  ...
  if (param_1 == (char *)0x0) {
                    /* try { // try from 00102628 to 0010267f has its CatchHandler @ 00102636 */
    uVar2 = std::__throw_logic_error("basic_string: construction from null is not valid");
                    /* catch() { ... } // from try @ 00102628 with catch @ 00102636 */
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 00102a4b to 00102a59 has its CatchHandler @ 00102a77 */
...
{
                    /* try { // try from 00102cb4 to 00102cb8 has its CatchHandler @ 00102cca */
  _M_dispose(this);
  _Alloc_hider::~_Alloc_hider((_Alloc_hider *)this);
  return;
}
...

{
  int iVar1;
                    ...
                    /* try { // try from 00102cf8 to 00102cfc has its CatchHandler @ 00102d13 */
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 00102e48 to 00102e4c has its CatchHandler @ 00102e8e */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00103062 to 0010307d has its CatchHandler @ 00103092 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 001032a1 to 001032a5 has its CatchHandler @ 001032b0 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 001032de to 0010331b has its CatchHandler @ 00103333 */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 001035f2 to 00103622 has its CatchHandler @ 00103631 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 00103718 to 0010372f has its CatchHandler @ 00103738 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 00103844 to 00103848 has its CatchHandler @ 001038a4 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...
{
                    /* try { // try from 00103b00 to 00103b08 has its CatchHandler @ 00103b11 */
  _M_set_length(this,0);
  return;
}
