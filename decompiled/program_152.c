...
/* WARNING: Removing unreachable block (ram,0x00101291) */
/* compare(std::vector<int, std::allocator<int> >, std::vector<int, std::allocator<int> >) */

vector<int,std::allocator<int>> *
compare(vector<int,std::allocator<int>> *param_1,vector<int,std::allocator<int>> *param_2,
...

{
  ...
  for (local_28 = 0; uVar3 = (ulong)local_28,
      uVar4 = std::vector<int,std::allocator<int>>::size(param_2), uVar3 < uVar4;
      local_28 = local_28 + 1) {
    piVar5 = (int *)std::vector<int,std::allocator<int>>::operator[](param_2,(long)local_28);
    iVar1 = *piVar5;
    piVar5 = (int *)std::vector<int,std::allocator<int>>::operator[](param_3,(long)local_28);
    iVar2 = *piVar5;
    local_2c = iVar2 - iVar1;
    if (iVar2 < iVar1) {
      local_2c = iVar1 - iVar2;
    }
                    /* try { // try from 00101258 to 00101260 has its CatchHandler @ 00101270 */
    std::vector<int,std::allocator<int>>::push_back(param_1,&local_2c);
  }
  return param_1;
}
...
{
                    /* try { // try from 001014e2 to 001014e6 has its CatchHandler @ 001014f8 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00101b99 to 00101b9d has its CatchHandler @ 00101ba8 */
...

{
  ...
  local_38[0] = 0x1fffffffffffffff;
                    /* try { // try from 00101c56 to 00101c62 has its CatchHandler @ 00101c76 */
  local_28 = param_1;
  local_20 = param_1;
  local_18 = param_1;
  local_10 = param_1;
