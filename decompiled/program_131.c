...

{
  ...
  local_18 = 0;
  local_10 = param_1;
  std::__cxx11::to_string(local_38,param_1);
  local_3c = 0;
  while( true ) {
    uVar2 = std::__cxx11::string::length((string *)local_38);
    if (uVar2 <= (ulong)(long)local_3c) break;
                    /* try { // try from 00102221 to 0010225d has its CatchHandler @ 00102279 */
    pcVar3 = (char *)std::__cxx11::string::operator[]((string *)local_38,(long)local_3c);
    iVar1 = local_14;
    if ((int)*pcVar3 % 2 == 1) {
      local_18 = 1;
      pcVar3 = (char *)std::__cxx11::string::operator[]((string *)local_38,(long)local_3c);
      local_14 = iVar1 * (*pcVar3 + -0x30);
    }
    local_3c = local_3c + 1;
  }
  if (local_18 == 0) {
...
/* WARNING: Removing unreachable block (ram,0x0010239e) */
...

{
  ...
  local_30 = CONCAT31(local_30._1_3_,bVar2);
                    /* try { // try from 0010238d to 00102391 has its CatchHandler @ 001023b1 */
...

{
  ...
  local_30 = this;
                    /* try { // try from 0010255b to 001025a6 has its CatchHandler @ 001025af */
...
{
                    /* try { // try from 001028c7 to 001028cb has its CatchHandler @ 001028d4 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 001028f4 to 001028f8 has its CatchHandler @ 00102954 */
