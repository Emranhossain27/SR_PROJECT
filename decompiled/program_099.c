...
/* count_upper(std::__cxx11::string) */

int count_upper(string *param_1)

{
  ...
  local_48 = &local_71;
                    /* try { // try from 00102226 to 00102235 has its CatchHandler @ 00102356 */
  local_50 = param_1;
  local_10 = local_48;
  std::__cxx11::string::string<std::allocator<char>>(local_70,"AEIOU",local_48);
  ...
  while( true ) {
    ...
    local_a8 = std::__cxx11::string::end(local_70);
                    /* try { // try from 001022c6 to 001022ed has its CatchHandler @ 00102375 */
    uVar4 = std::__cxx11::string::operator[](param_1,(long)(local_8c * 2));
