...
/* pairs_sum_to_zero(std::vector<int, std::allocator<int> >) */

undefined8 pairs_sum_to_zero(vector<int,std::allocator<int>> *param_1)

{
  ...
  do {
    ...
    uVar3 = std::vector<int,std::allocator<int>>::size(param_1);
    local_20 = local_1c;
    if (uVar3 <= uVar2) {
      local_9 = 0;
LAB_001011ed:
    ...
    while( true ) {
      local_20 = local_20 + 1;
      uVar3 = std::vector<int,std::allocator<int>>::size(param_1);
      if (uVar3 <= (ulong)(long)local_20) break;
      piVar4 = (int *)std::vector<int,std::allocator<int>>::operator[](param_1,(long)local_1c);
      iVar1 = *piVar4;
      piVar4 = (int *)std::vector<int,std::allocator<int>>::operator[](param_1,(long)local_20);
      uVar2 = (ulong)(uint)(iVar1 + *piVar4);
      if (iVar1 + *piVar4 == 0) {
        local_9 = 1;
        goto LAB_001011ed;
      }
