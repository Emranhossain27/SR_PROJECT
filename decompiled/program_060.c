...
int largest_prime_factor(int param_1)

{
  ...
  local_c = param_1;
  for (local_10 = 2; local_10 * local_10 <= local_c; local_10 = local_10 + 1) {
    for (; local_c % local_10 == 0 && local_10 < local_c; local_c = local_c / local_10) {
    }
  }
  return local_c;
}
