...
/* WARNING: Removing unreachable block (ram,0x00102442) */
/* string_xor(std::__cxx11::string, std::__cxx11::string) */

string * string_xor(string *param_1,string *param_2,string *param_3)

{
  ...
  local_30 = param_1;
  local_10 = local_28;
                    /* try { // try from 0010222e to 00102239 has its CatchHandler @ 00102359 */
  std::__cxx11::string::string<std::allocator<char>>(param_1,"",local_28);
  local_20 = (__new_allocator<char> *)&local_42;
  std::__new_allocator<char>::~__new_allocator(local_20);
  local_58 = 0;
  while( true ) {
    uVar2 = std::__cxx11::string::length(param_2);
    bVar4 = false;
    if ((ulong)(long)local_58 < uVar2) {
      uVar2 = std::__cxx11::string::length(param_3);
      bVar4 = (ulong)(long)local_58 < uVar2;
    }
    if (!bVar4) break;
    uVar2 = std::__cxx11::string::length(param_2);
    if (((ulong)(long)local_58 < uVar2) &&
       (uVar2 = std::__cxx11::string::length(param_3), (ulong)(long)local_58 < uVar2)) {
                    /* try { // try from 001022ff to 00102421 has its CatchHandler @ 0010237b */
      pcVar3 = (char *)std::__cxx11::string::operator[](param_2,(long)local_58);
      cVar1 = *pcVar3;
      pcVar3 = (char *)std::__cxx11::string::operator[](param_3,(long)local_58);
      if (cVar1 == *pcVar3) {
        std::__cxx11::string::operator+=(param_1,'0');
      }
      else {
        std::__cxx11::string::operator+=(param_1,'1');
      }
    }
    else {
      uVar2 = std::__cxx11::string::length(param_2);
      if ((ulong)(long)local_58 < uVar2) {
        pcVar3 = (char *)std::__cxx11::string::operator[](param_2,(long)local_58);
        std::__cxx11::string::operator+=(param_1,*pcVar3);
      }
      else {
        pcVar3 = (char *)std::__cxx11::string::operator[](param_3,(long)local_58);
        std::__cxx11::string::operator+=(param_1,*pcVar3);
...
{
                    /* try { // try from 00102614 to 00102618 has its CatchHandler @ 0010262a */
  _M_dispose(this);
  _Alloc_hider::~_Alloc_hider((_Alloc_hider *)this);
  return;
}
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 00102738 to 0010273c has its CatchHandler @ 0010277e */
...

{
  ...
  pcVar2 = (char *)_M_data(param_1);
                    /* try { // try from 00102952 to 0010296d has its CatchHandler @ 00102982 */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00102b91 to 00102b95 has its CatchHandler @ 00102ba0 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 00102bce to 00102c0b has its CatchHandler @ 00102c23 */
