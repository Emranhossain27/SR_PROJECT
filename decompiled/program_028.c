...
/* filp_case(std::__cxx11::string) */

string * filp_case(string *param_1,string *param_2)

{
  ...
  local_30 = param_1;
  local_10 = local_28;
                    /* try { // try from 00102229 to 00102234 has its CatchHandler @ 001022bc */
  ...
  for (local_50 = 0; uVar1 = (ulong)local_50, uVar2 = std::__cxx11::string::length(param_2),
      uVar1 < uVar2; local_50 = local_50 + 1) {
                    /* try { // try from 00102284 to 00102323 has its CatchHandler @ 001022de */
    pcVar3 = (char *)std::__cxx11::string::operator[](param_2,(long)local_50);
    local_51 = *pcVar3;
    if ((local_51 < 'a') || ('z' < local_51)) {
      if (('@' < local_51) && (local_51 < '[')) {
        local_51 = local_51 + ' ';
      }
    }
    else {
      local_51 = local_51 + -0x20;
    }
    std::operator+(local_78,(char)param_1);
...

{
  ...
  __cxx11::string::get_allocator();
                    /* try { // try from 0010253b to 00102549 has its CatchHandler @ 00102567 */
...

{
  ...
  char *local_40;
                    ...
                    /* try { // try from 001025af to 001026b4 has its CatchHandler @ 0010277a */
  _M_is_local(this);
...
{
                    /* try { // try from 001027a4 to 001027a8 has its CatchHandler @ 001027ba */
  _M_dispose(this);
  _Alloc_hider::~_Alloc_hider((_Alloc_hider *)this);
  return;
}
...

{
  ...
  char *pcVar1;
                    ...
                    /* try { // try from 001028c8 to 001028cc has its CatchHandler @ 0010290e */
...
{
  if (*(long *)this != 0) {
                    /* try { // try from 00102d21 to 00102d25 has its CatchHandler @ 00102d30 */
...

{
  ...
  local_28 = this;
                    /* try { // try from 00102d5e to 00102d9b has its CatchHandler @ 00102db3 */
...

{
  ...
  __new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_82);
                    /* try { // try from 00103072 to 001030a2 has its CatchHandler @ 001030b1 */
...

{
  ...
  pcVar1 = (char *)_M_local_data(this);
                    /* try { // try from 00103198 to 001031af has its CatchHandler @ 001031b8 */
...

{
  ...
  ulong local_30;
                    ...
                    /* try { // try from 001032c4 to 001032c8 has its CatchHandler @ 00103324 */
  bVar1 = _M_is_local(this);
  if ((bVar1 & 1) == 0) {
...
{
                    /* try { // try from 00103580 to 00103588 has its CatchHandler @ 00103591 */
  _M_set_length(this,0);
  return;
}
